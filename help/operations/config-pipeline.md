...
Mediante variables de entorno (o canalización) de tipo secreto, es posible que [propiedades secretas](#secret-env-vars) varíen por entorno, como ilustra la referencia `${{SPLUNK_TOKEN}}`
