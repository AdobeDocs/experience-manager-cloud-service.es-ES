...
que luego debe ir bajo `ui.apps/src/main/content/jcr_root`. Todas las definiciones de índice personalizadas y personalizadas deben almacenarse en `/oak:index`.
