...
Siempre que AEM procese una operación de manera asincrónica, recibirá una notificación en la [bandeja de entrada](/help/sites-cloud/authoring/inbox.md) y por correo electrónico (si está habilitada).

Para ver en detalle el estado de las operaciones asincrónicas, vaya a la página **[!UICONTROL Operaciones en segundo plano]**.

1. En la interfaz de Experience Manager, seleccione **Navegación global** > **Herramientas** > **General** > **Trabajos**.
...
1. En la página **[!UICONTROL Operaciones en segundo plano]**, revise los detalles de las operaciones.
   ...
   * **[!UICONTROL Programada]**: la operación está programada para procesarse más adelante
...
1. Inicie sesión en la consola web de AEM del Jar de inicio rápido de AEM SDK en `https://<host>:<port>/system/console` como usuario administrador.
...
1. Marque la opción **Habilitar notificación por correo electrónico** para recibir notificaciones por correo electrónico para este estado del trabajo.
1. Guarde los cambios.
