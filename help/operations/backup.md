...
>abstract="AEM as a Cloud Service restaurar la aplicación completa (código y contenido) de un cliente en tiempos específicos y predeterminados en los últimos siete días, sustituyendo lo que había en producción. Esta función solo debe usarse cuando haya problemas graves con el código o el contenido. Los datos recientes entre el momento de la copia de seguridad restaurada y el presente se perderán. El ensayo también se restaurará a la versión antigua."
...
>[!CAUTION]
>
>Esta función solo debe usarse cuando haya problemas graves con el código o el contenido. Los datos recientes entre el momento de la copia de seguridad restaurada y el presente se perderán. El ensayo también se restaurará a la versión antigua.
