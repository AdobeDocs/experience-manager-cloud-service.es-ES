...
En función de cómo utilice el Editor universal, hay diferentes opciones de implementación.

* [Flujo estándar](#standard-flow) - Para AEM as a Cloud Service o AMS que utilizan IMS
* [Flujo de terceros](#third-party-flow) - Para AEM in situ o AMS sin IMS
