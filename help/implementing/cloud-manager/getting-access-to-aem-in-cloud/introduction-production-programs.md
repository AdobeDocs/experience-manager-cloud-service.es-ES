...
Después de usted [cree su programa de producción,](creating-production-programs.md) a [asistente de creación de programas](using-the-wizard.md) guía al usuario a través de las selecciones según el objetivo del usuario al crear el programa.
