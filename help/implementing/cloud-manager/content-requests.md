...
| URL para que los clientes supervisen su programa de Cloud Service | Excluido | Dirección URL recomendada para supervisar externamente la disponibilidad.<br><br>`/system/probes/health` |
