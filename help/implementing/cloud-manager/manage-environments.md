...
Las capacidades de los entornos individuales dependen de las soluciones habilitadas en el [programa.](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/program-types.md)
...
>[!NOTE]
>
>El entorno debe estar en la versión `2021.05.5368.20210529T101701Z` de AEM o posterior. Asegúrese de que una canalización de actualización se haya ejecutado correctamente en su entorno para hacerlo.
