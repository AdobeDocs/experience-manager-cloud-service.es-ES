...
| Clasificación de fiabilidad | A = No hay errores <br/>B = Al menos 1 error menor <br/>C = Al menos 1 error mayor <br/>D = Al menos 1 error crítico<br>E = Al menos un error de bloqueo | Importante | &lt; D |
