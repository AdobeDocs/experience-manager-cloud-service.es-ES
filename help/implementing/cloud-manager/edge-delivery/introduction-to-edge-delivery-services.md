...
| 7 | Configurar validación push | Consulte [Configuración de validación push](/help/implementing/cloud-manager/cdn-configurations/cdn-setup-push-invalidation.md). |
