...
1. Asegúrese de haber creado el programa con una licencia de Edge Delivery Services antes de incorporar un sitio de Edge Delivery en Cloud Manager.
...
1. Realice una de las siguientes acciones:
   ...
   * En la esquina superior izquierda de la página, haga clic en ![Mostrar icono de menú](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ShowMenu_18_N.svg) para abrir el menú de la izquierda.
...
Cerca de la esquina superior derecha de la página, haz clic en ![Link icon o en Add](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Link_18_N.svg) **Add Edge Delivery site**.
...
1. En el cuadro de diálogo **Añadir sitio de Edge Delivery**, proporcione la siguiente información en los campos obligatorios:
   ...
   | Descripción del sitio (opcional) | Escriba una breve descripción del sitio de Edge Delivery que está agregando.<br>Una descripción ayuda a identificar y diferenciar el sitio, facilitando su administración y reconocimiento, entre otros sitios que ha agregado. |

1. En la esquina inferior derecha del cuadro de diálogo, haga clic en **Añadir**.

1. En el cuadro de diálogo **Verificar la propiedad del repositorio**, compruebe la propiedad del repositorio haciendo lo siguiente:
   ...
   | **2** | Agregue el código visto en el campo de texto del paso 2 al archivo que acaba de crear en el paso 1.<br>Si es necesario, haga clic en ![Icono de copiar](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Copy_18_N.svg) para copiar el código en el portapapeles. |
...
1. Haga clic en **Verificar**.
   ...
   >[!NOTE]
   >
   >Si el sitio de Edge Delivery Services utiliza la autenticación Helix, no se puede acceder al desafío de verificación. Deshabilite temporalmente la autenticación, complete la verificación del sitio y vuelva a activar la autenticación.



Cuando se verifica el repositorio, se actualiza su estado en la tabla de sitios de Edge Delivery. El círculo verde con una marca de verificación blanca en el interior indica el estado.
