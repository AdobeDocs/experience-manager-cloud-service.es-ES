...
Si la versión original no cumple estos criterios, la versión generada se anexa a la original como segmento de nueva versión. La versión generada también se ajusta para admitir una ordenación y administración de versiones precisas. Por ejemplo, suponiendo una versión generada de `2019.926.121356.0000020490`, se obtienen los siguientes resultados.
