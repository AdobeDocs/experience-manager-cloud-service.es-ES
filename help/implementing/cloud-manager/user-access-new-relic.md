...
* Acceso directo a una cuenta específica de New Relic One (acceso administrado por el soporte técnico de Adobe)
...
>[!NOTE]
>
>Si está administrando los usuarios de New Relic One, también debe agregarse como usuario para tener acceso a él. Ser el **Propietario del negocio** o el **Administrador de implementación** no es suficiente para tener acceso a New Relic One. También debe crearse un usuario.
...
* Se puede agregar un máximo de 25 usuarios. Si se ha alcanzado el número máximo de usuarios, elimine usuarios para poder agregar nuevos.
...
Para obtener más ayuda o instrucciones adicionales sobre las nuevas ofertas de Relic One para su programa de AEM as a Cloud Service, abra un ticket de asistencia a través del [Portal de asistencia de AEM](https://helpx.adobe.com/enterprise/using/support-for-experience-cloud.html).
...
Se concederá acceso de lectura completo hasta para 10 miembros de su equipo. El acceso de lectura incluirá todas las métricas de APM recopiladas por el agente de New Relic One.
...
Mientras que el soporte de Adobe supervisará la aplicación de AEM as a Cloud Service mediante New Relic One y otras herramientas internas como parte de su servicio, sus equipos pueden seguir aprovechando New Relic para servicios e infraestructura alojados localmente. Podrán visualizar los datos tanto de la cuenta de Adobe New Relic One como de las cuentas de New Relic administradas por el cliente.
