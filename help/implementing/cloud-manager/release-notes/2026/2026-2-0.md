---
title: Notas de la versión 2026.2.0 de Cloud Manager
description: Obtenga información sobre la versión 2026.2.0 de Cloud Manager en Adobe Experience Manager as a Cloud Service.
...
# Notas de la versión 2026.2.0 de Cloud Manager en Adobe Experience Manager as a Cloud Service {#release-notes}

<!-- https://wiki.corp.adobe.com/display/DMSArchitecture/%5BKT%5D+Cloud+Manager+2025.08.0+Release -->

Obtenga información sobre la versión 2026.2.0 de Cloud Manager en AEM (Adobe Experience Manager) as a Cloud Service.
...
La fecha de lanzamiento de Cloud Manager 2026.2.0 en AEM as a Cloud Service es el viernes, 05 de febrero de 2026.

La próxima versión planificada es el viernes, 05 de marzo de 2026.
