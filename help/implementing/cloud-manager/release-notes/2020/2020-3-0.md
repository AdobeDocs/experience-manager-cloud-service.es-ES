...
* La creación simultánea de entornos de desarrollo en el mismo programa de Cloud Service podía encontrar una condición en la que solo se podía crear uno correctamente.
* Las notificaciones de CX Enterprise para los programas de Cloud Service no se recibían de forma coherente.
