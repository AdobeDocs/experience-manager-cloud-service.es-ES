...
El panel de control aprovecha Google Lighthouse, una herramienta automatizada de código abierto para mejorar la calidad de sus aplicaciones web. Puede ejecutarlo en cualquier página web, pública o que requiera autenticación. Tiene auditorías de rendimiento, accesibilidad, aplicaciones web progresivas, SEO y más.

¿Está interesado en probar el nuevo panel de control? Envíe un correo electrónico a `aem-lighthouse-pilot@adobe.com` desde el correo electrónico asociado a su Adobe ID para comenzar.
