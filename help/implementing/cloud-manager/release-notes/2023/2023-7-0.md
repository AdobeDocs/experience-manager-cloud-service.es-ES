...
* Las tarjetas de la página de destino de Cloud Manager indican si [seguridad mejorada](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/creating-production-programs.md) está habilitada para sus programas.
...
* Los usuarios ahora pueden obtener acceso a [registros del proceso de copia de contenido](/help/implementing/developing/tools/content-copy.md#accessing-logs). Esta opción solo está disponible si los entornos de origen y destino se encuentran en la versión de AEM `2023.7.12549` o superior.

## Correcciones de errores {#bug-fixes}

* La navegación a la IU de creación desde Cloud Manager ya no produce errores al redirigir a CX Enterprise después del inicio de sesión.
