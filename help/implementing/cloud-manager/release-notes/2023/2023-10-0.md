...
La fecha de lanzamiento de Cloud Manager 2023.10.0 en AEM as a Cloud Service es el 5 de octubre de 2023. La versión siguiente fue planificada para el 2 de noviembre de 2023.

## Novedades {#what-is-new}

* Las mejoras en la [indexación](/help/operations/indexing.md) han reducido la duración de la canalización al implementar nuevos índices.
   * Las mejoras varían según el perfil de contenido.
* Las [actualizaciones automáticas para entornos de desarrollo](/help/implementing/cloud-manager/manage-environments.md#updating-environments) están habilitadas de forma predeterminada en los nuevos programas, lo que le ahorra el tiempo necesario para ejecutar las actualizaciones manualmente.
...
si está interesado en probar esta nueva característica y compartir sus comentarios, envíe un mensaje de correo electrónico a `Grp-CloudManager-custom-permissions@adobe.com` desde su dirección de correo electrónico asociada a su Adobe ID.
