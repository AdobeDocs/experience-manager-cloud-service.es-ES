...
description: Estas son las notas de la versión para Cloud Manager 2023.9.0 en AEM as a Cloud Service.
...
AEM La fecha de lanzamiento de la versión 2023.9.0 de Cloud Manager en la versión as a Cloud Service de es el 14 de septiembre de 2023. El próximo lanzamiento está programado para el 5 de octubre de 2023.
...
¿Está interesado en probar el nuevo tablero? Comience enviando un correo electrónico a `aem-lighthouse-pilot@adobe.com` de su correo electrónico asociado a su Adobe ID.
