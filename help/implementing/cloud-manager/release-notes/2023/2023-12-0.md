...
description: Estas son las notas de la versión para Cloud Manager 2023.12.0 en AEM as a Cloud Service.
...
La fecha de lanzamiento de Cloud Manager 2023.12.0 en AEM as a Cloud Service es el 14 de diciembre de 2023. La próxima versión está planificada para el 18 de enero de 2024.
...
* Los [permisos personalizados de Cloud Manager](/help/implementing/cloud-manager/custom-permissions.md) le permiten crear perfiles de permisos personalizados con permisos configurables para restringir el acceso a programas, canalizaciones y entornos para los usuarios de Cloud Manager.
   ...
   * Envíe un mensaje de correo electrónico a `Grp-CloudManager-custom-permissions@adobe.com` desde la dirección de correo electrónico asociada a su Adobe ID si desea habilitarlo antes.
...
* Para los programas de Cloud Manager recién creados, [la subcuenta de New Relic asociada](/help/implementing/cloud-manager/user-access-new-relic.md) no está activada de manera predeterminada.
   ...
   * Si desea utilizar la subcuenta de New Relic, debe optar por su inclusión a través de Cloud Manager.
