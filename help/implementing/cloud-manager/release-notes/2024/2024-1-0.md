...
* Cloud Manager ahora valida las fechas de caducidad no solo para el principal [certificado,](/help/implementing/cloud-manager/managing-ssl-certifications/introduction-to-ssl-certificates.md) sino también para certificados intermedios.
