...
* Se agregaron [nuevas reglas de OakPal](/help/implementing/cloud-manager/custom-code-quality-rules.md#oakpal-ui-content-package) al análisis de calidad del código de Cloud Manager. Cada nueva regla añadida a partir de junio de 2024 es un cambio no disruptivo.Se le recomienda abordar estas reglas lo antes posible, ya que pueden provocar errores en las canalizaciones a partir de la versión de Cloud Manager de agosto de 2024.
