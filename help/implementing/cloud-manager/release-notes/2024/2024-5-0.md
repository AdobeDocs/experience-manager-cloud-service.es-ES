...
* Ahora se puede acceder al [tablero de licencias](/help/implementing/cloud-manager/license-dashboard.md) a través de un punto de entrada distinto en la [navegación](/help/implementing/cloud-manager/navigation.md) izquierda.
