...
description: Notas de la versión para Cloud Manager en la versión as a Cloud Service 2021.10.0 de Adobe Experience Manager AEM ()
...
* A fin de prepararse para algunos cambios, ahora se hace referencia a las canalizaciones de implementación existentes y se etiquetan en la interfaz de usuario como **Pila completa** canalizaciones.
