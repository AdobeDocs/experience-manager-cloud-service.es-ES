...
* El registro de implementación descargado por un usuario de Cloud Manager es más perspicaz, ya que ahora incluye detalles sobre errores y escenarios de éxito.
