...
* El registro de implementación descargado por un usuario de Cloud Manager es más profundo y ahora incluirá detalles sobre errores y escenarios de éxito.
