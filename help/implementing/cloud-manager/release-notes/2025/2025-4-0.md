...
* **(IU) Mejora de validación de dominio**
  ...
  Al agregar un dominio, Cloud Manager muestra un error si ya está instalado en una cuenta de Fastly: &quot;*Dominio ya instalado en Fastly. Quítelo antes de agregarlo a Cloud Service.*&quot;

## Programa Private Beta {#private-beta-program}

Para obtener acceso exclusivo a las próximas funciones antes de su lanzamiento general, participe en el programa beta privado de Cloud Manager.
...
>[!NOTE]
>
>Actualmente, las comprobaciones de calidad del código de las solicitudes de extracción predeterminadas son exclusivas de los repositorios alojados en GitHub, pero se está trabajando en una actualización para ampliar esta funcionalidad a otros proveedores de Git.
...
* **Unicidad aplicada para nombres de redirecciones de puertos de redes avanzadas**
  ...
  Cloud Manager ahora aplica un nombre único para redirecciones de puertos de redes avanzadas. Anteriormente, se permitían nombres duplicados, lo que provocaba conflictos. Esta corrección garantiza que cada entrada de redirección de puerto tenga un nombre distinto, de acuerdo con las prácticas recomendadas para la integridad de la configuración de red. <!-- CMGR-67082 -->
