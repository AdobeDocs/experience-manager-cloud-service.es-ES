...
En Adobe Cloud Manager, puede editar una configuración de nombre de dominio personalizado por los siguientes motivos:
...
Para actualizar el certificado SSL de un nombre de dominio personalizado, siga los mismos pasos descritos anteriormente.
...
>[!WARNING]
>
>Quite los registros DNS del dominio con su proveedor DNS *antes* de eliminar el dominio en Cloud Manager. Las entradas DNS no utilizadas pueden verse comprometidas y suponer un riesgo para la seguridad.
...
1. Desde la página **Entornos**, vaya a una pantalla de detalles del entorno seleccionado.
