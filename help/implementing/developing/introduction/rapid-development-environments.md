...
1. Utilice la variable [herramienta de copia de contenido](/help/implementing/developing/tools/content-copy.md) para copiar un conjunto de contenido definido de entornos prod, stage o dev, o de otro RDE.
