...
>
>
Sin embargo, las anulaciones suelen definirse en `/apps`, ya que la mejor práctica AEM como Cloud Service es definir las personalizaciones en `/apps`; esto se debe a que no debe cambiar nada debajo de `/libs`.
