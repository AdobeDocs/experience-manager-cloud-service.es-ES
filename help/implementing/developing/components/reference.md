...
Un editor in situ permite al usuario editar contenido directamente en el flujo de contenido, sin necesidad de abrir un cuadro de diálogo. Por ejemplo, el estándar **Texto** y **Título** ambos componentes tienen un editor de entrada.
...
La siguiente configuración habilita la edición en el lugar de entrada del componente y define `plaintext` como tipo de editor:
