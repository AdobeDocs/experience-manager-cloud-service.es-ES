...
1. Seleccione el **[!UICONTROL Carril de búsqueda de bandeja de entrada]** Configuración de y pulse **[!UICONTROL Editar]**.
...
1. Seleccione el **[!UICONTROL Carril de búsqueda de bandeja de entrada]** Configuración de y pulse **[!UICONTROL Eliminar]**.
...
1. Pulse el botón **[!UICONTROL Seleccionar predicado]** tabulación y arrastre **[!UICONTROL Predicado de intervalo]** al formulario.
...
1. Abra el [formulario para configuración](#creating-opening-customized-configuration).
1. Pulse el botón **[!UICONTROL Seleccionar predicado]** tabulación y arrastre **[!UICONTROL Predicado de texto]** al formulario.
1. En el **[!UICONTROL Configuración]** pestaña, seleccione el nombre de la columna Bandeja de entrada en la que basar la búsqueda, desde **[!UICONTROL Nombre de columna]** field.
...
1. Abra el [formulario para configuración](#creating-opening-customized-configuration).
1. Pulse el botón **[!UICONTROL Seleccionar predicado]** tabulación y arrastre **[!UICONTROL Predicado de intervalo de fechas]** al formulario.
1. En el **[!UICONTROL Configuración]** pestaña, seleccione el nombre de la columna Bandeja de entrada en la que basar la búsqueda, desde **[!UICONTROL Nombre de columna]** field.
...
1. Abra el [formulario para configuración](#creating-opening-customized-configuration).
1. Pulse el botón **[!UICONTROL Seleccionar predicado]** tabulación y arrastre **[!UICONTROL Predicado de opciones de columna personalizadas]** al formulario.
1. En el **[!UICONTROL Configuración]** pestaña, seleccione el nombre de la columna Bandeja de entrada en la que basar la búsqueda, desde **[!UICONTROL Nombre de columna]** field.
...
1. En el **[!UICONTROL Agregar opciones]** sección:
   ...
   1. Seleccionar **[!UICONTROL Ruta de opciones CRX]** para definir opciones mediante las rutas del repositorio CRX. Tocar **[!UICONTROL Añadir rutas de opción]** para añadir varias rutas. El siguiente es un ejemplo para definir `Male` y `Female` opciones de filtro:
