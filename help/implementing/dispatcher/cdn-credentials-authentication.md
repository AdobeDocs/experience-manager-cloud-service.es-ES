...
**Preferido: Variables secretas de canalización.** Utilice variables secretas de canalización cuando sea posible, ya que se implementan junto con la configuración en la misma ejecución de canalización. Esto mantiene los secretos y la configuración sincronizados y simplifica los despliegues.
