...
>[!NOTE]
>
>Los dominios personalizados se admiten en Cloud Manager **only** si utiliza la CDN administrada de AEM. Si trae su propia CDN y [diríjala a la CDN administrada de AEM](#point-to-point-CDN) tendrá que usar esa CDN específica para administrar dominios, no Cloud Manager.
