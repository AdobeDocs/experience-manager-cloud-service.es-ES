...
# Creación de AEM con Edge Delivery Services {#edge-dev-getting-started}
...
1. Vuelva a la raíz del repositorio y haga clic en `paths.yaml` y luego en el icono **Editar este archivo**.
...
1. Reemplace las asignaciones predeterminadas por `/content/<site-name>/:/` y haga clic en **Confirmar cambios...**.
   ...
   * Las asignaciones indican a los Edge Delivery Services cómo asignar el contenido del repositorio de AEM a la dirección URL del sitio.
   ...
   ![Actualización de paths.yaml](assets/edge-dev-getting-started/paths-update.png)
...
1. Añada un mensaje de confirmación si lo desea y haga clic en **Confirmar cambios**, confirmándolos directamente en la rama `main`.
   ...
   ![Cambios en la confirmación](assets/edge-dev-getting-started/commit-fstab-changes.png)
...
1. Solicite la última plantilla del sitio de creación de informes de Edge Delivery Services de Adobe Engineering a través de su [canal del Slack del proyecto.](/help/edge/docs/slack.md)
