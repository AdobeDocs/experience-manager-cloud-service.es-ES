...
* Ha completado la [Guía de introducción para desarrolladores para la creación de contenido con Edge Delivery Services de AEM](/help/edge/edge-dev-getting-started.md).

Esta guía se basa en el trabajo realizado en la guía [Guía de introducción para desarrolladores para la creación de contenido con Edge Delivery Services de AEM](/help/edge/edge-dev-getting-started.md).
...
1. Clone el proyecto de GitHub localmente que ha creado en la [Guía de introducción para desarrolladores para la creación de contenido con Edge Delivery Services de AEM](/help/edge/edge-dev-getting-started.md) y ábrala en un editor de su elección.
...
1. Edite el archivo `component-models.json` en la raíz del proyecto y añada la siguiente [definición de modelo](/help/implementing/universal-editor/field-types.md#model-structure) para el nuevo bloque de presupuesto; guarde el archivo.
   ...
   * Consulte el documento [Modelado de contenido para la creación de proyectos con Edge Delivery Services de AEM](/help/edge/content-modeling.md) para obtener más información acerca de lo que es importante tener en cuenta al crear modelos de contenido.
...
1. Con git, confirme estos cambios en su rama `main`.
   ...
   * Confirmar `main` es solo para fines ilustrativos. [Siga las prácticas recomendadas](https://www.aem.live/docs/dev-collab-and-good-practices) y utilice una solicitud de extracción para el trabajo real del proyecto.
...
1. En un explorador, inicie sesión en AEM as a Cloud Service. [Mediante la consola de Sites,](/help/sites-cloud/authoring/basic-handling.md) vaya al sitio que creó en la [Guía de introducción para desarrolladores para la creación de contenido con Edge Delivery Services de AEM](/help/edge/edge-dev-getting-started.md) y seleccione una página.
