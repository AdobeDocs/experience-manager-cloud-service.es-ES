---
title: Servicio de entrega perimetral de AEM Forms
...
El bloque de formulario le ayuda a crear fácilmente formularios para capturar y almacenar los datos capturados. Admite componentes basados en todos los HTML 5 [input-types](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#input_types) como texto, correo electrónico, número, fecha y muchos más. También admite [área de texto](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/textarea), [select](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/select), y [fieldset](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/fieldset) e incluye funciones de validación de entrada nativas de HTML5.

El bloque de formulario genera una estructura de HTML uniforme para todos los tipos de campo y contenedores (paneles), lo que garantiza la coherencia. Esta estructura coherente facilita la [aplicar estilo a un formulario](/help/edge/docs/forms/style-theme-forms.md).


## Propiedades de componentes

Las siguientes propiedades son compatibles con los componentes de formulario del bloque de formulario:

<table>
 <tbody>
  <tr>
   <td><b>Propiedad</b> </td>
   <td><b>Componentes de formulario (tipo de entrada)</b> </td>
   <td><b>Detalles</b></td>
  </tr>
  <tr>
   <td>Nombre</td>
   <td>Todos los componentes</td>
   <td> Cadena que especifica el nombre del componente. Los datos del componente se envían con este nombre.
   </td>
  </tr>
  <tr>
   <td>Etiqueta</td>
   <td>Todos los componentes</td>
   <td> La etiqueta sirve como pie de ilustración del campo.
   </td>
  </tr>
  <tr>
   <td>Valor</td>
   <td>Todos los componentes</td>
   <td> El valor inicial del control. Para los componentes de radio y casilla de verificación, este es el valor/datos que se envía cuando se seleccionan. El atributo value siempre es opcional, aunque debe considerarse obligatorio para la casilla de verificación y el aparato de radio.
   </td>
  </tr>
    <tr>
