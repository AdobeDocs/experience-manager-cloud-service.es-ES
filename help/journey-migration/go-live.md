...
>abstract="AEM Para garantizar un lanzamiento sin problemas y exitoso de las versiones as a Cloud Service de la aplicación, debe planificar períodos de congelación de código y contenido, iteraciones de prueba, recargas de contenido, pruebas de rendimiento, pruebas de seguridad y mucho más."
...
* Cree grupos de notificación de usuarios Admin Console. Consulte [Grupos de usuarios para notificaciones](/help/journey-onboarding/user-groups.md)
