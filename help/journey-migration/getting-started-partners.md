...
4. **Acceder a registros**
   ...
   * [mediante Adobe de e/s cli](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/logs.html#debugging)
...
3. [CRXDE Lite](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/repository-browser.html) (solo disponible en los entornos de SDK local y de desarrollo de Experience Manager Cloud)
...
>1. [Póngase en contacto con el equipo de soporte técnico del Experience Manager](https://experienceleague.adobe.com/docs/customer-one/using/home.html)
...
2. [Administrador de paquetes](https://experienceleague.adobe.com/docs/experience-manager-65/administering/contentmanagement/package-manager.html#package-manager) : se usa para importar y exportar contenido mutable del repositorio.
...
2. Ejecutar código de cliente a través de [Cloud Manager Quality Pipeline](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/content/using/code-quality-testing.html)
