...
AEM Junto con estas mejoras, se han introducido varias diferencias entre las instalaciones on-premise de y Adobe Managed Services AEM, en comparación con las as a Cloud Service.
...
<tbody>
  ...
  <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/operations/maintenance.html">AEM Tareas de mantenimiento as a Cloud Service</a></td>
  ...
  <tr>
    ...
    <td><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/operations/backup.html">AEM Copia de seguridad y restauración as a Cloud Service</a></td>
    <td></td>
  </tr>
  <tr>
...
* [AEM Página de inicio de Cloud Service de](/help/overview/introduction.md) : para obtener una descripción general de la documentación as a Cloud Service del Experience Manager, comience aquí.
* [AEM Resumen as a Cloud Service de](/help/overview/introduction.md) : Esta guía proporciona información general sobre Experience Manager as a Cloud Service, incluida una introducción, terminología y arquitectura.
