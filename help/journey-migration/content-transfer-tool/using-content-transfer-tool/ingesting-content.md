...
1. Proporcione la información necesaria para crear una nueva ingesta.
   ...
   * Seleccione el entorno de destino. Aquí es donde se ingiere el contenido del conjunto de migración. Seleccione el nivel. (Autor/Publicación).
...
>abstract="Utilice la función superior para mover el contenido modificado desde la actividad de transferencia de contenido anterior. Una vez finalizada la ingesta, compruebe los registros para ver si hay errores o advertencias. Cualquier error debe solucionarse inmediatamente, ya sea tratando con los problemas notificados o poniéndose en contacto con el Servicio de atención al cliente de Adobe."
...
Release Orchestrator mantiene actualizados automáticamente los entornos mediante la aplicación automática de actualizaciones. Si la actualización se activa cuando se realiza una ingesta, puede causar resultados impredecibles, incluida la corrupción del entorno. Esa es una de las razones por las que se debe registrar un ticket de asistencia antes de iniciar una ingesta (consulte la &quot;Nota&quot; anterior), de modo que se pueda programar la desactivación temporal del Release Orchestrator.
