...
* AEM [Modernizador de repositorio](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/moving/refactoring-tools/repo-modernizer.html?lang=es), una herramienta que toma un proyecto multimodo de la aplicación como entrada y lo convierte en un proyecto de AEM as a Cloud Service
