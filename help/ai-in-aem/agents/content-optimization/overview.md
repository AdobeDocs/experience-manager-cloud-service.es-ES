...
* **[Colaboración perfecta con Discovery Agent](/help/ai-in-aem/agents/discovery/overview.md)**: se basa en los recursos identificados por Discovery Agent, lo que permite la recuperación y optimización de recursos de un extremo a otro a través de una conversación natural.
...
* **Creación de representación de alta resolución**
  ...
  Busque el recurso correcto mediante [Discovery agent](/help/ai-in-aem/agents/discovery/overview.md) y, a continuación, utilice las indicaciones siguientes en caso de que se produzcan varios resultados de búsqueda:
...
* El agente de optimización de contenido no admite actualmente recursos PNG.
