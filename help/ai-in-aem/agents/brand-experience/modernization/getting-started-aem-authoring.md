...
1. Compruebe que `fstab.yaml` apunta a su host de AEM, propietario de Git y repositorio de Git, y confirme cualquier cambio en `main` antes de conectar las aplicaciones de GitHub.
