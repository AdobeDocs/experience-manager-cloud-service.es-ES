...
* Entorno de ensayo:
   ...
   * Este siempre se asocia a un único entorno de producción individual.
...
* Nivel de publicación de Edge Delivery:
   * Permite el procesamiento dinámico de páginas web y contenido de API a partir de varias fuentes de contenido, como el nivel de creación de documentos de AEM o el nivel de creación basado en documentos
...
* El servicio Métrica de usuario real (RUM):
   * Es responsable de recopilar las métricas clave de una experiencia del cliente (como vistas de página, elementos vitales web principales y eventos de conversión) y responder a las consultas asociadas (por ejemplo, las vistas de página principales de un dominio determinado en los últimos 7 días).
...
La conversión a HTML semántico se produce a partir del contenido publicado servido desde el nivel de creación de AEM o desde el entorno de creación basado en documentos.
