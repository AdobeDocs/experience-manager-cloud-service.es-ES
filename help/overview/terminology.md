...
| Red de Envío de contenido (CDN) | AEM as Cloud Service se envía con una CDN predeterminada. Su principal objetivo es reducir la latencia mediante la entrega de contenido procesable desde los nodos CDN en el borde, cerca del explorador. Está completamente administrado y configurado para un rendimiento óptimo de las aplicaciones AEM. |
