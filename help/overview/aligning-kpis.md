...
1. **Elija los tres indicadores más relevantes para su negocio.** Estos indicadores son los KPI. Podrían coincidir con tres metas empresariales (cada una de ellas defendida por un ejecutivo de nivel C diferente) o los KPI podrían apoyar el mismo objetivo, si todos están de acuerdo en que es el más importante.
