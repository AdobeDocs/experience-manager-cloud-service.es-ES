...
El parámetro `kind` debe establecerse en `CDN` y la versión debe establecerse en la versión del esquema, que actualmente es `1`. Vea los siguientes ejemplos.
...
* Adobe recomienda el uso de [regex101](https://regex101.com/) y [Fastly Fiddle](https://fiddle.fastly.dev/) cuando se utiliza una expresión regular. También puede obtener más información sobre cómo Fastly gestiona la expresión regular de este [artículo](https://www.fastly.com/documentation/reference/vcl/regex/#best-practices-and-common-mistakes).
...
Se puede configurar una regla para enviar una notificación del Centro de acciones si se activa 10 veces en un intervalo de 5 minutos. Esta regla le alerta cuando se producen ciertos patrones de tráfico para que pueda tomar las medidas necesarias. Obtenga más información sobre el [Centro de acciones](/help/operations/actions-center.md), incluyendo cómo configurar los perfiles de notificación necesarios para recibir correos electrónicos.
