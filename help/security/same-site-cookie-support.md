...
Una vez que se actualiza esta configuración, se cierra la sesión de los usuarios y se inicia sesión de nuevo, las cookies `login-token` tienen el conjunto de atributos `None` y se incluyen en solicitudes entre sitios.
