...
## Pasos para configurar Turnstile {#steps-to-configure-hcaptcha}
...
## Uso del torniquete en componentes principales de un Forms adaptable {#using-turnstile-core-components}
