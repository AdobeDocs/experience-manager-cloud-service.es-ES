...
# Generar una PDF de envío (anteriormente documento de registro) para Forms adaptable (componentes principales)

## Información general {#overview}

Cuando se rellena o se envía un formulario, se puede guardar un registro del formulario, impreso o en formato de documento. Este registro se denomina PDF de envío (anteriormente Documento de registro o DoR). Se trata de un PDF del formulario enviado que puede imprimirse. También puede consultar la PDF de envío para obtener la información que los clientes hayan rellenado en una fecha posterior o utilizar la PDF de envío para archivar formularios y contenido en formato PDF.
...
Sí. AEM Forms admite la generación de PDF de envío (anteriormente, documento de registro), lo que permite a las aseguradoras producir PDF y registros basados en los datos de los formularios enviados.
...
Para crear una PDF de envío, una plantilla basada en XFA o AcroForm se combina con los datos recopilados mediante un formulario adaptable. Puede generar una PDF de envío automáticamente o bajo demanda. La opción bajo demanda permite especificar una plantilla personalizada basada en XFA o AcroForm para proporcionar un aspecto personalizado a la PDF de envío.
...
La página maestra de una plantilla base se utiliza como página maestra de la plantilla de PDF de envío. La página maestra puede tener información como un encabezado de página, un pie de página y un número de página que puede aplicar al PDF de envío. Puede aplicar dicha información a la PDF de envío mediante la plantilla base para la generación automática de la PDF de envío. El uso de una plantilla base permite cambiar las propiedades predeterminadas de los campos.
...
Ahora puede utilizar el formulario guardado como plantilla base para una PDF de envío. No modifique ni elimine ningún script presente en la plantilla base.
...
1. En función de si selecciona una plantilla predeterminada o personalizada, algunas o todas las propiedades siguientes aparecen en la pestaña Documento de registro. Especifique las siguientes propiedades mencionadas para definir el aspecto de la PDF de envío:
   ...
   1. **Propiedades básicas**:
      ...
      * **Incluir objetos de formulario que no están enlazados al modelo de datos**: al establecer la propiedad se incluyen campos no enlazados del formulario adaptable basado en esquemas de la PDF de envío.
