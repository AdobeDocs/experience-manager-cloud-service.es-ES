...
1. [Uso de configuraciones regionales añadidas en Forms adaptable](#use-added-locale-in-af)
...
1. [Agregar carpeta específica de nombre de configuración regional](#add-locale-name-specific-folder)
1. [Agregar la compatibilidad con la configuración regional del diccionario.](#add-locale-support-for-the-dictionary)
1. [Confirmar los cambios en el repositorio e implementar la canalización](#commit-changes-in-repo-deploy-pipeline)
...
##### 3.2. Agregar la biblioteca de cliente de formulario adaptable para una carpeta locale-name
...
#### 4. Agregar compatibilidad con configuración regional para el diccionario {#add-locale-support-for-the-dictionary}
...
#### 5. Confirme los cambios en el repositorio e implemente la canalización {#commit-changes-in-repo-deploy-pipeline}
