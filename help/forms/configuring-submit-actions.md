...
# Acción de envío para formularios adaptables basada en componentes de base
...
Los [formularios adaptables basados en el componente de base](/help/forms/creating-adaptive-form.md) admiten varias [acciones de envío listas para usar](#submit-actions-supported-by-adaptive-forms-based-on-foundation-components). Se activa una acción de envío cuando un usuario hace clic en el botón **[!UICONTROL Enviar]** en un formulario adaptable. 

## Acciones de envío para formularios basadas en componentes de base

Los formularios adaptables admiten las siguientes acciones de envío basándose en componentes de base:
...
También puede enviar un formulario adaptable basado en componentes de base a otras configuraciones de almacenamiento:
...
Además, puede [personalizar las acciones de envío predeterminadas](/help/forms/custom-submit-action-form.md) para que se ajusten a requisitos específicos de su organización.

### Configurar una acción de envío para un formulario basado en componentes de base
...
![Acción de envío de AEM Forms](/help/forms/assets/submit-form-foundation-component.png)
