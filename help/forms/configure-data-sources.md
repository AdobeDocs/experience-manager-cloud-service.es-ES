...
1. Especifique los siguientes detalles para el servicio RESTful:
   ...
   * Seleccione el tipo de autenticación: None, OAuth2.0([Código de autorización](https://oauth.net/2/grant-types/authorization-code/), [Credenciales del cliente](https://oauth.net/2/grant-types/client-credentials/)), Autenticación básica, Clave de API o Autenticación personalizada: para acceder al servicio RESTful y, en consecuencia, proporcione detalles para la autenticación.
