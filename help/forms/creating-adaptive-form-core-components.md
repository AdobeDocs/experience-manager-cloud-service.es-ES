...
1. Inicie sesión en su instancia de autor [!DNL Experience Manager Forms]. Puede ser una instancia de nube o una instancia de desarrollo local.
...
## Componentes principales de formularios adaptables disponibles
