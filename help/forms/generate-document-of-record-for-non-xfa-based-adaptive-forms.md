...
# Generar un PDF de envío (anteriormente, documento de registro) para Forms adaptable
...
Cuando se rellena o se envía un formulario, se puede guardar un registro del formulario, en formato impreso o en formato de documento. Este registro se denomina PDF de envío (anteriormente Documento de registro o DoR). Se trata de un PDF del formulario enviado que puede imprimirse. También puede consultar la PDF de envío para obtener la información que los clientes hayan rellenado en una fecha posterior o utilizar la PDF de envío para archivar formularios y contenido en formato PDF.

![PDF de envío (anteriormente documento de registro)](assets/document-of-record.png)

Para crear una PDF de envío, una plantilla basada en XFA o AcroForm se combina con los datos recopilados mediante un formulario adaptable. Puede generar una PDF de envío automáticamente o bajo demanda.
La opción bajo demanda permite especificar una plantilla personalizada basada en XFA o AcroForm para proporcionar un aspecto personalizado a la PDF de envío.
...
Vincule los campos de formulario adaptable con los campos de plantilla para mostrar los datos de formulario capturados en el campo correspondiente de PDF de envío. Para enlazar componentes de formulario adaptable con campos de plantilla de PDF de envío correspondientes:
...
Puede usar la acción de envío de correo electrónico, la acción de envío del flujo de trabajo de Experience Manager junto con el paso de [Documento de registro y otras acciones de envío](configuring-submit-actions.md) para recibir un PDF de envío.

## Actualizaciones incrementales en la plantilla de PDF de envío {#document-of-record-template-incremental-updates}

Los formularios adaptables y las plantillas de PDF de envío correspondientes pueden evolucionar a lo largo del tiempo. Puede elegir entre agregar, quitar o modificar campos a un formulario adaptable o a una plantilla de PDF de envío.
...
El desarrollador de formularios enlaza los campos de Forms adaptable con la plantilla de PDF de envío correspondiente.

>[!VIDEO](assets/we-retail-binding.mp4)

Ahora, cuando se envía el formulario adaptable, se crea un PDF de envío actualizado.
...
* **Compatibilidad con texto enriquecido**: PDF de envío admite etiquetas de marcado HTML en campos de texto enriquecido. Para obtener información detallada sobre las etiquetas compatibles y las consideraciones de accesibilidad, consulte [Etiquetas de marcado HTML compatibles en el PDF de envío](html-markup-tags-support-in-document-of-record.md).
...
* No se admiten enlaces de contenido en PDF de envío generados para formularios adaptables basados en el esquema XML.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td> </td>
   <td>false</td>
   <td>No disponible en la plantilla de PDF de envío. Solo disponible en PDF de envío mediante archivos adjuntos.</td>
  </tr>
 </tbody>
</table>
...
|---|---|---|
| Imagen | Imagen | Los componentes TextDraw e Image, estén enlazados o no, siempre aparecen en la PDF de envío de un formulario adaptable basado en XSD, a menos que se excluyan en la configuración del PDF de envío. |

### Tablas {#tables}

Los componentes de las tablas de formularios adaptables, como el encabezado, el pie de página y la fila, se asignan a los componentes XFA correspondientes. Puede asignar paneles repetibles a tablas en Submission PDF.

## Plantilla base de un PDF de envío {#base-template-of-a-document-of-record}

La plantilla base proporciona información de estilo y apariencia a Submission PDF. Permite personalizar el aspecto predeterminado del PDF de envío generado automáticamente. Por ejemplo, puede utilizar la plantilla base para agregar el logotipo de su empresa en el encabezado y la información de copyright en el pie de página de PDF de envío.

La página maestra de la plantilla base se utiliza como página maestra de la plantilla de PDF Envío. La página maestra puede tener información como el encabezado de página, el pie de página y el número de página que puede aplicar a PDF de envío. Puede aplicar dicha información a PDF de envío mediante la plantilla base para la generación automática de PDF de envío. El uso de una plantilla base permite cambiar las propiedades predeterminadas de los campos.
...
Se utiliza una plantilla base para definir el encabezado, el pie de página, el estilo y la apariencia de una PDF de envío. El encabezado y pie de página pueden incluir información como el logotipo de la empresa y la información de copyright. La primera página maestra de la plantilla base se copia y se utiliza como página maestra de la PDF de envíos, que contiene el encabezado, el pie de página, el número de página o cualquier otra información que deba aparecer en todas las páginas de la PDF de envíos. Si utiliza una plantilla base que no se ajusta a las convenciones de plantilla base, la primera página maestra de la plantilla se seguirá utilizando en la plantilla de PDF Envío. Se recomienda encarecidamente que diseñe la plantilla base según sus convenciones y que la utilice para la generación automática de Submission PDF.
...
Ahora puede utilizar el formulario guardado como plantilla base para PDF de envío. No modifique ni elimine ningún script presente en la plantilla base.
...
## Personalización de la información de marca en Envío PDF {#customize-the-branding-information-in-document-of-record}

Al generar una PDF de envío, puede cambiar la información de marca de la PDF de envío en la pestaña Documento de registro. La pestaña Documento de registro incluye opciones como logotipo, apariencia, diseño, encabezado y pie de página, exención de responsabilidad y si desea incluir o no las opciones de casillas de verificación y botones de opción no seleccionadas.

Para localizar la información de marca indicada en la pestaña Documento de registro, asegúrese de que la configuración regional del explorador esté correctamente configurada. Para personalizar la información de marca de PDF de envío, realice los siguientes pasos:

1. Seleccione un panel (panel raíz) en la PDF de envío y, a continuación, seleccione ![configure](assets/configure.png).
1. Seleccione ![dortab](assets/dortab.png). Aparecerá la pestaña Documento de registro.
1. Seleccione la plantilla predeterminada o una plantilla personalizada para procesar el PDF de envío. Si selecciona la plantilla predeterminada, aparece una vista previa en miniatura de la PDF de envío debajo de la lista desplegable Plantilla.
1. En función de si selecciona una plantilla predeterminada o personalizada, algunas o todas las propiedades siguientes aparecen en la pestaña Documento de registro. Especifique las siguientes propiedades mencionadas para definir el aspecto de la PDF de envío:
   ...
   1. **Propiedades básicas**:
      ...
      * **Color de énfasis**: El color en el que se representa el texto del encabezado y las líneas de separación en el PDF de envío.
      * **Familia de fuentes**: Familia de fuentes del texto en el PDF de envío.
      ...
      * **Incluir objetos de formulario que no están enlazados al modelo de datos**: al establecer la propiedad se incluyen campos no enlazados del formulario adaptable basado en esquemas de PDF de envío.
      * **Excluir campos ocultos del documento de registro**: al establecer la propiedad, se identifican los campos ocultos para la exclusión del PDF de envío.
      * **Ocultar descripción de paneles**: al establecer la propiedad, se excluye la descripción del panel o la tabla del PDF de envío. Aplicable para paneles y tablas.
...
1. Abra la pestaña **[!UICONTROL Plantilla del documento de registro]** y seleccione una de las siguientes opciones:
   ...
   * **[!UICONTROL Asociar plantilla de formulario como plantilla de documento de registro]**:When: si se selecciona esta opción, el formulario XFA se utilizará como plantilla para el envío de PDF.
...
* **Excluir del documento de registro**: al establecer la propiedad en True, se excluye el campo del PDF de envío. Se trata de una propiedad que puede ser script y que se llama `excludeFromDoR`. Su comportamiento depende de la propiedad de nivel de formulario **Excluir campos del documento de registro si están ocultos**.
...
* **Incluir campos no enlazados en el documento de registro:** Al establecer la propiedad, se incluyen los campos no enlazados del formulario adaptable basado en esquema en PDF de envío. De forma predeterminada, es True.
* **Excluir campos del documento de registro si están ocultos:** Establezca la propiedad para excluir los campos ocultos del PDF de envío al enviar el formulario. Cuando habilita [Revalidar en el servidor](/help/forms/configuring-submit-actions.md#server-side-revalidation-in-adaptive-form-server-side-revalidation-in-adaptive-form), el servidor vuelve a calcular los campos ocultos antes de excluir esos campos de la PDF de envío.
