...
>[!TAB Formularios adaptables]

Forms adaptable permite a las empresas crear y administrar formularios interactivos basados en datos para sus sitios web y otros canales digitales sin necesidad de formularios adaptables y fáciles de usar para móviles. </br> </br> Forms adaptable de AEM también incluye un generador de formularios de arrastrar y soltar, que permite a los usuarios no técnicos crear y personalizar fácilmente formularios utilizando componentes de formulario pregenerados como cuadros de texto, menús desplegables y selectores de fechas. Esto permite una creación de formularios más rápida y elimina la necesidad de una codificación y un desarrollo extensos. </br> </br> Además, AEM Adaptive Forms ofrece otras funciones, entre ellas: <ul><li>Flujos de trabajo avanzados para enrutamiento, aprobación y envío de datos de formulario Validación en tiempo real y comprobación de errores para garantizar la precisión de los datos </li><li>Integración con fuentes de datos de terceros y API para rellenar previamente campos de formulario o validar datos </li><li>Funciones avanzadas de análisis e informes para realizar el seguimiento del uso de formularios, las tasas de conversión y otras métricas clave </li><li>Integración con Adobe Sign y ArchiveSign para firmas electrónicas </li>

>[!TAB Servicio de conversión automatizada de formularios ]

El servicio de automated forms conversion permite a las empresas convertir formularios heredados basados en PDF en formularios digitales interactivos que se pueden administrar y distribuir fácilmente en línea. El servicio ayuda en los aspectos siguientes: <ul><li>Reduce los esfuerzos manuales necesarios para convertir la impresión de formularios en formularios adaptables.</li><li>Aplica los correspondientes patrones y validaciones durante la conversión</li><li>Genera documentos de registro durante la conversión </li><li>Agrupar campos que se producen con frecuencia en fragmentos de formulario reutilizables </li> <li>Activa Adobe Analytics durante la conversión</li>

>[!TAB API de comunicaciones (servicios de documentos)]

Las API de comunicaciones son un conjunto de API de RESTful (interfaces de programación de aplicaciones) que permiten a las empresas automatizar la creación, administración y entrega de comunicaciones personalizadas basadas en datos. </br> </br> Estas API también permiten a las empresas integrar sus flujos de trabajo de comunicaciones con sistemas de terceros y fuentes de datos, lo que les permite crear mensajes personalizados y con un público objetivo muy preciso activados por eventos específicos o comportamientos de usuario. Algunas de las funciones clave de las API de comunicaciones de AEM Forms son:<ul><li> Entrega dinámica de contenido: Las API permiten a las empresas crear y entregar contenido dinámico diseñado para usuarios individuales en función de sus preferencias, comportamientos e interacciones anteriores con la empresa.</li> <li>Mensajería personalizada: Las API permiten a las empresas personalizar sus comunicaciones mediante la inclusión de datos específicos del usuario, como nombres, direcciones e historial de compras.</li><li>Integración con sistemas back-end: Las API pueden integrarse con una amplia gama de sistemas back-end, incluidos CRM, bases de datos y plataformas de automatización de marketing.</li><li> Generar documentos de PDF Pixel Perfect: Las API generan documentos PDF con una precisión de píxeles y personalizados con contenido y datos específicos del usuario. Esta función permite a las empresas crear documentos altamente profesionales y publicados, como facturas, contratos y declaraciones, que se entregan a los usuarios en formato de PDF.

>[!TAB Análisis avanzado]

El servicio proporciona soporte de OOTB para conectarse con Adobe Analytics. La conexión de formularios con Adobe Analytics ofrece varias ventajas para las empresas, entre ellas: <ul><li> Se ha mejorado la comprensión del comportamiento del usuario: Al conectar formularios con Adobe Analytics, las empresas pueden comprender mejor cómo interactúan los usuarios con sus formularios. Esto incluye perspectivas sobre la participación del usuario, las tasas de conversión, los puntos de exclusión y otras métricas clave que pueden ayudar a las empresas a identificar áreas para mejorar y optimizar sus formularios para mejorar las experiencias del usuario. </li><li>Mejor segmentación de los esfuerzos de marketing: Al analizar el comportamiento del usuario en los formularios, las empresas pueden obtener perspectivas valiosas sobre las preferencias e intereses del usuario. Esta información se puede utilizar para dirigir mejor los esfuerzos de marketing y crear campañas más efectivas que impulsen la participación y las conversiones. </li><li> Tasa de error reducida: Al integrar formularios con Adobe Analytics, puede encontrar perspectivas sobre el campo con la mayoría de errores y mejorar la calidad de los datos, lo que permite tomar decisiones mejor y obtener perspectivas más precisas. </li><li> ROI mejorado: Al optimizar los formularios en función de la información obtenida de Adobe Analytics, las empresas pueden mejorar las tasas de conversión y aumentar los ingresos procedentes de sus canales digitales. Esto puede conducir a un mayor retorno de la inversión (ROI) en las iniciativas digitales y de marketing, ayudando a las empresas a lograr sus objetivos e impulsar el crecimiento.</li>
