---
title: Cómo utilizar hCaptcha&reg; en un componente de base de formulario adaptable de AEM
...
## Uso de Chcaptcha® en un formulario adaptable{#using-hCaptcha&reg;-foundation-components}
