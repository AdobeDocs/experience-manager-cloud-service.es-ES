---
title: Componentes de formulario para Edge Delivery Services de AEM Forms
description: Edge Delivery Services de AEM Forms está diseñado para ofrecer un rendimiento máximo, lo que le permite imaginar el futuro de la recopilación de datos optimizada y la participación del usuario. El artículo enumera todos los componentes de formularios disponibles de forma predeterminada para los formularios EDD.
...
# Componentes de HTML admitidos en Form Block Edge Delivery
...
Esta es la tabla que describe cómo se corresponden los componentes principales con los tipos de entrada de HTML-5 en Edge Delivery:
...
<table>
 <tbody>
  ...
  <tr>
   <td><a href ="https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/adaptive-forms-components/form-container.html?lang=es">Contenedor del formulario</a></td>
  ...
  <tr>
   ...
   <td><a href ="https://developer.mozilla.org/es-es/docs/Web/HTML/Element/select">select</a></td>
  ...
  <tr>
   ...
   <td><a href ="https://developer.mozilla.org/es-es/docs/Web/HTML/Element/input/checkbox">casilla de verificación múltiple</a></td>
  ...
  <tr>
   ...
   <td><a href ="https://developer.mozilla.org/es-es/docs/Web/HTML/Element/input/radio">radio múltiple</a></td>
  ...
  <tr>
   ...
   <td><a href ="https://developer.mozilla.org/es-es/docs/Web/HTML/Element/fieldset">conjunto de campos con leyenda</a></td>
   ...
   <td><a href ="https://developer.mozilla.org/es-es/docs/Web/HTML/Element/fieldset">fieldset</a></td>
