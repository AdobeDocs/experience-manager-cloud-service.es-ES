...
* Ahora los usuarios pueden acceder a una nueva opción de menú **Iniciar sesión localmente** desde las opciones de menú entorno de las páginas de resumen de Entornos y tarjeta de Entorno.
