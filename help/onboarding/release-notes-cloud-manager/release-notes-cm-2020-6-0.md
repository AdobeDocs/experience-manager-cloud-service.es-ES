---
title: Notas de la versión de Cloud Manager en AEM como Cloud Service, versión 2020.6.0
description: Notas de la versión de Cloud Manager en AEM como Cloud Service, versión 2020.6.0
...
# Notas de la versión de Cloud Manager en Adobe Experience Manager como Cloud Service 2020.6.0 {#release-notes}

Esta página describe las Notas de la versión de Cloud Manager en AEM como Cloud Service 2020.6.0.

## Fecha de la versión {#release-date}

La fecha de versión de Cloud Manager en AEM como Cloud Service 2020.6.0 es el 4 de junio de 2020.
