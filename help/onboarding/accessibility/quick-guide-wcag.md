...
Además de los componentes básicos de los Principios, Directrices y Criterios de Éxito de WCAG 2.0, hay una serie de documentos de apoyo. Algunos de ellos proporcionan consejos específicos sobre cómo cumplir con los aspectos de las directrices, otros son referencias más generales que ayudan a autores web, diseñadores y desarrolladores de todas las capacidades a comprender y utilizar WCAG 2.0 con la mayor eficacia posible.
...
Esto se refiere a una serie de documentos, que proporcionan consejos para ayudar a los lectores a apreciar el propósito de directrices específicas y criterios de éxito. Puede [descargar una introducción, además de vínculos a información](https://www.w3.org/TR/2008/NOTE-UNDERSTANDING-WCAG20-20081211/Overview.html)más detallada.
