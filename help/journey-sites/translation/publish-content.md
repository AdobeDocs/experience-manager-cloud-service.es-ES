...
En el documento anterior del recorrido de traducción de AEM Sites, [Traducir contenido,](configure-connector.md) ha aprendido a utilizar AEM proyectos de traducción para traducir su contenido. Ahora debería:
