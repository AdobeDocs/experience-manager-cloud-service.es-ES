...
En el documento anterior del recorrido de traducción de AEM Sites, [Configure Translation Rules](translation-rules.md) ha aprendido a utilizar AEM reglas de traducción para identificar su contenido de traducción. Ahora debería:
...
1. Vaya a **Navegación** -> **Sitios** y pulse o haga clic en el proyecto.
...
1. Vaya a **Navegación** -> **Proyectos**.
1. Toque o haga clic en el proyecto creado en la sección anterior ([Creación automática de un proyecto de traducción basado en la ruta de contenido](#automatically-creating) o [Creación manual de un proyecto de traducción seleccionando su contenido](#manually-creating) según su situación).
...
* **Trabajo de traducción** : Esta tarjeta o estos programas de tarjetas proporcionan una visión general del trabajo de traducción real, incluido el estado, el número de recursos, etc. Generalmente hay un trabajo por idioma con el código de idioma ISO-2 anexado al nombre del trabajo.
   * Tenga en cuenta que cuando [crea automáticamente trabajos de traducción,](#automatically-creating) AEM crea los trabajos asincrónicamente y es posible que no aparezcan inmediatamente dentro del proyecto.
...
1. En la tarjeta **Summary** , pulse o haga clic en el botón de elipsis situado en la parte inferior de la tarjeta.
1. En la pestaña **Avanzado**, desmarque la opción **Eliminar lanzamiento después de la promoción**.
...
>[!TIP]
>
>Procesar un trabajo de traducción puede llevar cierto tiempo y es posible que vea que los elementos de traducción pasan del estado **Borrador** a **Traducción en curso** a **Listo para revisión** antes de que lleguen al estado **Aprobado**. Esto es esperable.

>[!NOTE]
>
>Si no desactivó la opción del proyecto **Eliminar lanzamiento después de la promoción** como [se describe en la sección anterior, los elementos traducidos ](#using-translation-project) aparecerán con el estado **Eliminados**. Esto es normal, ya AEM descarta automáticamente los registros de traducción una vez que llegan los elementos traducidos. Los artículos traducidos se han importado como copias de idiomas, sólo se han eliminado los registros de traducción porque ya no son necesarios.
>
>No te preocupes si esto no está claro. Estos son detalles exhaustivos de cómo funciona AEM y no afectan a su comprensión del recorrido. Si desea profundizar en cómo procesa AEM traducciones, consulte la sección [recursos adicionales](#additional-resources) al final de este artículo.
...
Si se desplaza a esta carpeta a través de **Navegación** -> **Sitios**, verá el contenido traducido.
