...
Hay una serie de consolas disponibles para administrar sus flujos de trabajo. Utilice la navegación [](/help/sites-cloud/authoring/getting-started/basic-handling.md#global-navigation) global para abrir el panel **Herramientas** y, a continuación, seleccione **Flujo de trabajo**:
