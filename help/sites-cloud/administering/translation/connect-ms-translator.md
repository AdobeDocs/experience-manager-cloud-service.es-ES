...
1. En el [panel de navegación](/help/sites-cloud/authoring/basic-handling.md#first-steps), seleccione **Herramientas** > **Cloud Services** > **Cloud Services de traducción**.
