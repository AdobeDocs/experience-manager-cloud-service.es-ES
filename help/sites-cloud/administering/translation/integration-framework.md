...
description: Aprenda a configurar el marco de trabajo de integración de traducciones para vincularlo a servicios de traducción de terceros.
...
El marco de trabajo de integración de traducciones se vincula a los servicios de traducción de terceros para organizar la traducción de contenido de AEM. Requiere tres pasos básicos.

1. [Conéctese a su proveedor de servicios de traducción.](#connecting-to-a-translation-service-provider)
1. [Cree una configuración del marco de trabajo de integración de traducciones.](#creating-a-translation-integration-configuration)
...
>[!TIP]
>
>Si no tiene experiencia en la traducción de contenidos, consulte nuestro [Recorrido de traducción de sitios](/help/journey-sites/translation/overview.md), una ruta guiada por la traducción del contenido de AEM Sites mediante las potentes herramientas de traducción de AEM, ideal para quienes no tengan experiencia ni en traducción ni en AEM.
...
Después de instalar un paquete de conector, puede crear una configuración de la nube para él. Normalmente, debe proporcionar sus credenciales para autenticarse en el servicio de traducción. Para obtener información sobre cómo añadir una configuración de la nube para el conector de Microsoft Translator, consulte [Integración con Microsoft Translator](connect-ms-translator.md).
...
## Creación de una configuración de integración de traducciones {#creating-a-translation-integration-configuration}
...
* Si la traducción será humana o automática
...
1. En el [menú de navegación global](/help/sites-cloud/authoring/getting-started/basic-handling.md#global-navigation), toque o haga clic en **Herramientas -> Cloud Services y Cloud Services de traducción**.
...
1. En la ventana **Editar configuración**, configure las propiedades de las pestañas **Sitios** y **Recursos** y, a continuación, toque o haga clic en **Guardar y cerrar**.
...
| Traducir recursos | Activela para incluir recursos en el proyecto de traducción. |
| Traducir metadatos | Actívela para traducir metadatos de recursos. |
...
Tenga en cuenta que la configuración de la nube del marco de trabajo de integración de traducciones identifica la configuración de la nube que se utilizará para la conexión con el proveedor de servicios. Cuando asocia una página de origen con una configuración de la nube de marco de trabajo, la página debe asociarse a la configuración de la nube del proveedor de servicios que utiliza la configuración de la nube del marco de trabajo.

Cuando asocia una página con una configuración de la nube, los descendientes de la página heredan la asociación. Por ejemplo, si asocia la página `/content/wknd/language-masters/en/magazine` con un marco de trabajo de integración de traducciones, la página `magazine` y las páginas secundarias inferiores se traducen según el marco de trabajo.

Si es necesario, puede anular la asociación en una página descendiente. Por ejemplo, el contenido de un sitio web trata sobre todo de viajes y estilo de vida. Sin embargo, una rama de páginas describe a la compañía. En tal caso, la página raíz del sitio puede asociarse con un marco de trabajo de integración de traducciones que especifique la traducción automática con la categoría Estilo de vida, mientras que la rama que describe la compañía utilizará otro con la categoría General.
...
1. En el desplegable **Añadir configuración**, seleccione la configuración.
1. Haga clic o pulse en **Guardar y cerrar**.

### Asociación de páginas a un marco de trabajo de integración de traducciones {#associating-pages-with-a-translation-integration-framework}

Asocie una página al marco de trabajo de integración de traducciones que define cómo desea llevar a cabo la traducción de la página y de las páginas descendientes.
