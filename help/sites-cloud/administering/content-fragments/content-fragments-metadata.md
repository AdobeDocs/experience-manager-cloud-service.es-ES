...
description: Consulte cómo puede ver y editar las propiedades de metadatos de AEM fragmentos de contenido.
...
2. O bien:
   ...
   * Select [**Ver propiedades** para abrir los cuadros de diálogo](/help/assets/manage-digital-assets.md#editing-properties). Una vez abierto para su visualización, también puede editarlo.
...
3. La variable **Básico** proporciona opciones que puede ver o editar:
