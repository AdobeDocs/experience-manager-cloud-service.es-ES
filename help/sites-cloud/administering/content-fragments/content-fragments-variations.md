...
description: Descubra cómo las variaciones le permiten crear contenido para el fragmento y luego crear variaciones de ese contenido según el propósito. Esto proporciona una mayor flexibilidad para la entrega sin encabezado y la creación de páginas.
...
[Variaciones](/help/sites-cloud/administering/content-fragments/content-fragments.md#constituent-parts-of-a-content-fragment) son una función significativa de los fragmentos de contenido de Adobe Experience Manager AEM (). Permiten crear y editar copias del contenido principal para utilizarlas en canales y escenarios específicos, lo que hace que la creación de páginas y la entrega de contenido sin encabezado sean aún más flexibles.
...
Cuando abra el fragmento de contenidos para editarlo, la pestaña **Variaciones** se abre de forma predeterminada. Aquí puede crear el contenido, para Principal o cualquier variación que tenga. El fragmento estructurado contiene campos de varios tipos de datos definidos en el modelo de contenido.
...
* Edite el contenido directamente en la pestaña de **Variaciones**; cada tipo de datos proporciona diferentes opciones de edición, por ejemplo:
   ...
   * para **Texto de varias líneas** , también puede abrir los campos [editor de pantalla completa](#full-screen-editor) hasta:
   ...
   * Para **Referencia a fragmento** , los campos [Editar fragmento de contenido](#fragment-references-edit-content-fragment) La opción puede estar disponible, según la definición del modelo.

* Asignar **Etiquetas** a la variación actual; las etiquetas se pueden añadir, actualizar y eliminar.

   * [Etiquetas](/help/sites-cloud/authoring/features/tags.md) son útiles a la hora de organizar los fragmentos, ya que se pueden utilizar para la clasificación de contenido y la taxonomía. Las etiquetas se pueden utilizar para buscar contenido (mediante etiquetas) y aplicar operaciones por lotes.
...
* [Insertar fragmento de contenido](#inserting-content-fragment-into-your-fragment); disponible cuando su **Texto de varias líneas** el campo está configurado con **Permitir referencia a fragmento**.
...
>[!CAUTION]
>
>Si selecciona **Texto sin formato**, puede perder cualquier formato, marca o recurso que haya insertado en **Texto enriquecido** o **Markdown**.

### Markdown {#markdown}

>[!NOTE]
>
>Para obtener información completa, consulte [Markdown](/help/sites-cloud/administering/content-fragments/content-fragments-markdown.md).
...
Cuando el editor de pantalla completa está abierto, la acción **Estadísticas de texto** muestra un rango de información acerca del texto.
...
>[!NOTE]
>
>En un nivel más técnico, el sistema mantiene las frases que califica como que proporcionan el *mejor relación entre densidad y singularidad de la información* según algoritmos específicos.
...
1. Seleccionar **Aplicar** en el cuadro de diálogo.
...
1. Cierre el editor de pantalla completa y las anotaciones se seguirán resaltando. Si se selecciona, se abrirá un cuadro de diálogo para que pueda editar la anotación con mayor precisión.
...
* Se indica mediante el resaltado en el texto, tanto en pantalla completa como en modo normal del editor. Los detalles completos de una anotación se pueden ver, editar o eliminar haciendo clic en el texto resaltado, que vuelve a abrir el cuadro de diálogo.
...
* Se pueden enumerar y eliminar seleccionando la opción **Anotaciones** en el editor de fragmentos.

  ![anotaciones](assets/cfm-variations-08.png)

* Se pueden ver y eliminar en el [Cronología](/help/sites-cloud/administering/content-fragments/content-fragments-managing.md#timeline-for-content-fragments) para el fragmento seleccionado.

### Inserción de recursos en el fragmento {#inserting-assets-into-your-fragment}

Para facilitar el proceso de creación de fragmentos de contenido, puede agregar lo siguiente [Assets](/help/assets/manage-digital-assets.md) (imágenes) directamente al fragmento.
...
1. Utilice el **Insertar recurso** para abrir el cuadro de diálogo de búsqueda.
...
1. Utilice el **Insertar fragmento de contenido** para abrir el cuadro de diálogo de búsqueda.
...
title="Variaciones: Crear contenido de fragmentos"
abstract="Aprenda a crear variaciones de contenido para utilizarlas con canales específicos."
...
Las variaciones le permiten tomar la **Principal** contenido y puede variar según el propósito (si es necesario).
...
1. Se abre un cuadro de diálogo, especifique el **Título** y **Descripción** para la nueva variación.
1. Seleccione **Agregar**; el fragmento **Principal** se copia en la nueva variación, que ahora está abierta para [editar](#editing-a-variation).
   ...
   >[!NOTE]
   >
   Al crear una variación, todas las variables **Etiquetas** asignado actualmente a **Principal** se copian en la nueva variación.

### Edición de una variación {#editing-a-variation}

Puede editar el contenido de la variación después de lo siguiente:
...
1. Confirme el **Eliminar** acción en el cuadro de diálogo.
...
>
La sincronización solo funciona en **Texto multilínea** tipo de datos.
>
