...
Si está editando una página en el [editor de páginas,](/help/sites-cloud/authoring/page-editor/introduction.md) se puede publicar directamente desde el editor.
