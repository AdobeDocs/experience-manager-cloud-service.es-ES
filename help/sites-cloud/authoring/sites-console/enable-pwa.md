...
En lugar de requerir ninguna grabación del sitio, un autor de contenido puede configurar las propiedades del PWA como una pestaña adicional en el [propiedades de página](/help/sites-cloud/authoring/sites-console/page-properties.md) de un sitio.
...
1. Seleccione el proyecto de sitios y seleccione [**Propiedades**](/help/sites-cloud/authoring/sites-console/page-properties.md) o utilice la tecla de acceso directo `p`.
