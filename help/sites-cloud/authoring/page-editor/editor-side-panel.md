...
Para obtener información más detallada sobre los componentes disponibles, consulte [Consola de componentes](/help/sites-cloud/authoring/components-console.md)
