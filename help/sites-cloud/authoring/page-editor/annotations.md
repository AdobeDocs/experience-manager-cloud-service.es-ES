...
>[!TIP]
>
>No olvide que también dispone de los [comentarios](/help/sites-cloud/authoring/basic-handling.md#timeline) para ofrecer opiniones sobre una página.

Se utiliza un modo [especial](/help/sites-cloud/authoring/page-editor/introduction.md#mode-selector) para crear y ver anotaciones.
