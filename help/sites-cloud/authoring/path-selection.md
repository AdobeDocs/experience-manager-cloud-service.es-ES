---
title: Selección de rutas con el navegador de rutas
description: AEM Obtenga información sobre cómo utilizar el explorador de rutas para seleccionar recursos en la.
...
A menudo, durante la creación es necesario seleccionar otro recurso, como cuando se define un vínculo a otra página o se selecciona una imagen. Para poder seleccionar una ruta con facilidad, los [campos de ruta](#path-fields) ofrecen la opción de completado automático y el [explorador de rutas](#path-browser) permite una selección más sólida.
...
![Botón Abrir cuadro de diálogo de selección](assets/path-selection-open-selection-dialog.png)
...
* Puede utilizar en cualquier momento el campo de búsqueda situado en la parte superior del cuadro de diálogo.
   * Haga clic en **X** en el campo de búsqueda para borrar la búsqueda.
...
![Opción Filtros](assets/path-selection-filters.png)
