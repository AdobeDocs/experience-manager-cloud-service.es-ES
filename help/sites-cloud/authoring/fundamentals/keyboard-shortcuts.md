...
Hay varios métodos abreviados del teclado disponibles mediante AEM. Algunos se aplican al editar páginas, otros a la variable [uso de consolas](/help/sites-cloud/authoring/getting-started/keyboard-shortcuts.md)y algunos, en particular, [Consola Fragmentos de contenido](/help/sites-cloud/administering/content-fragments/content-fragments-console-keyboard-shortcuts.md).
...
También hay varios métodos abreviados del teclado disponibles para los usuarios de escritorio que usan la variable [consolas](/help/sites-cloud/authoring/getting-started/keyboard-shortcuts.md)y algunos, en particular, [Consola Fragmentos de contenido](/help/sites-cloud/administering/content-fragments/content-fragments-console-keyboard-shortcuts.md).
