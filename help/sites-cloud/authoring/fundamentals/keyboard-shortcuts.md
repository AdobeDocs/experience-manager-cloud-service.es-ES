...
|---|---|---|
| Cualquier modo de ventana de edición | `Ctrl-Shift-m` | Alternar entre **Vista previa** y el [mode](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)</a> (por ejemplo, **Editar**, **Diseño**, etc.* |
