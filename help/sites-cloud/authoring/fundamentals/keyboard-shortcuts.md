...
Hay varios métodos abreviados del teclado disponibles mediante AEM. Algunos se emplean en la edición de páginas y otros son para [el uso de las consolas](/help/sites-cloud/authoring/getting-started/keyboard-shortcuts.md).
...
|---|---|---|
| Cualquier modo de ventana de edición | `Ctrl-Shift-m` | Alternar entre **Vista preliminar** y el [modo](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)</a> seleccionado actualmente (p. ej., **Editar**, **Diseño**, etc.).* |
...
También hay varios métodos abreviados del teclado disponibles para los usuarios de escritorio que usan las [consolas](/help/sites-cloud/authoring/getting-started/keyboard-shortcuts.md).
