...
description: Use el modo de anotación para dejar anotaciones y bocetos en páginas del mismo modo que utilizaría notas adhesivas para ayudarle en el proceso de revisión de contenido
...
La creación de contenido para la experiencia digital suele requerir análisis y comentarios antes de la publicación. Para facilitar este proceso de dejar comentarios, AEM permite añadir anotaciones al contenido.

Una anotación coloca un boceto simple o una nota (piense en una nota adhesiva del mundo real) en la página. La anotación le permite dejar comentarios o preguntas para otros autores y revisores.
...
>[!TIP]
>
>En función de sus necesidades, también puede desarrollar un [flujo de trabajo](/help/sites-cloud/authoring/workflows/overview.md) para enviar notificaciones cuando estas se añadan, actualicen o eliminen.
...
1. Accede al modo Anotar mediante el icono de la barra de herramientas (parte superior derecha) al editar una página:
...
1. Para salir del modo de anotación y volver al anterior, toque o haga clic en el botón x, en la parte derecha de la barra de herramientas superior.
...
1. Haga clic o toque el icono Añadir anotación (símbolo más a la izquierda de la barra de herramientas) para empezar a añadir anotaciones.
...
1. Toque o haga clic fuera del cuadro de diálogo de anotaciones para cerrarlo. Se mostrará una vista truncada de la anotación, junto con los bocetos, si los hay:
...
1. Cuando haya terminado de editar una anotación concreta, puede hacer lo siguiente:
   ...
   * Haga clic o toque el marcador de texto para abrir la anotación. Una vez abierto, puede ver el texto completo, hacer cambios o [eliminar la anotación.](#deleting-annotations)
...
1. Tocar o hacer clic en el marcador de texto para abrir la anotación.

1. Toque o haga clic en el icono Eliminar.

   ![Eliminar anotación](/help/sites-cloud/authoring/assets/annotation-delete.png)

1. Se elimina la anotación y todos los bocetos asociados.
...
1. Toque o haga clic en el boceto. AEM lo resalta con un cuadro azul más oscuro.
   ...
   ![Seleccione el boceto para su eliminación](/help/sites-cloud/authoring/assets/annotation-sketch-delete.png)

1. Presione la tecla Supr del teclado.

1. El boceto se elimina, pero la anotación se mantiene.
