...
## Pruebas sin encabezado (el programa se ha suprimido) {#headless-trials-promotion}
...
<table>
  ...
  <tr>
    ...
    <td>La lista desplegable de opciones se establece mediante la propiedad <b>Invocar servicio</b> del Editor de reglas. 
   </td>
   </tr>
     </tr>
   <tr>
...
## Véase también Editor de reglas {#see-also-rule-editor}
...
>[!IMPORTANT]
>
>El editor de SPA [ha quedado obsoleto](/help/implementing/developing/hybrid/spa-editor-deprecation.md) para nuevos proyectos. Sigue siendo compatible con Adobe para los proyectos existentes, pero no debe utilizarse para nuevos proyectos. Los editores preferidos para administrar contenido en AEM ahora son:
>
>* [El Editor universal](https://www.aem.live/docs/aem-authoring) para editar contenido sin encabezado de forma visual.
...
## Autenticación sin encabezado del editor universal {#ue-headless-auth}
...
Para acelerar la creación del sitio, Adobe proporciona una serie de plantillas adaptadas a diferentes finalidades.
