...
+ Recorrido de migración de AEM as a Cloud Service {#migration-journey}
   ...
   + Notas de la versión de las herramientas de migración {#release-notes-migration-tools}
      + [Notas de la versión actual (2022.4.0)](/help/journey-migration/release-notes/release-notes-migration-tools-current.md)
...
+ Assets {#assets}
   ...
   + Dynamic Media {#dynamicmedia}
      + recorrido de Dynamic Media {#dm-journey}
         + [Conceptos básicos, parte I](/help/assets/dynamic-media/dm-journey-part1.md)
         + [Básico, Parte II](/help/assets/dynamic-media/dm-journey-part2.md)
