...
Si desea restringir la lista a autores que proporcionen la variación especificada (y omitir autores que recurran a los datos originales), aplique una [filter](#filtering):
