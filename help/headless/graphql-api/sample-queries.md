...
>[!NOTE]
>
>Según la instancia, puede acceder directamente a la variable [Interfaz GraphiQL incluida con la API de AEM GraphQL](/help/headless/graphql-api/graphiql-ide.md) para enviar y probar consultas.
>
