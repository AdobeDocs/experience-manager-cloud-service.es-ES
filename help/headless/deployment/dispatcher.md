...
La comodín `*` abre varios puntos de conexión en la instancia de AEM. La consulta mediante un extremo de GraphQL se realiza mediante `POST` y la respuesta **no** se almacenarán en caché.
