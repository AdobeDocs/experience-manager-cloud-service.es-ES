...
|----|----|----|------|-----|-----|
| Métodos de implementación | Apropiado para el cual [!DNL Assets] oferta. | Assets Essentials | Cloud Service, Adobe Managed Services, On-Premise | Servicio de nube de  |
| **General** |
