---
title: Invalidación de la caché de CDN (red de entrega de contenido) mediante Dynamic Media Classic
...
1. Haga clic en **[!UICONTROL Configuración]** > **[!UICONTROL Configuración de la aplicación]** > **[!UICONTROL Configuración general]**.
...
1. En la interfaz de usuario de Dynamic Media Classic (Scene7), seleccione uno o varios recursos y, a continuación, pulse **[!UICONTROL Archivo]** > **[!UICONTROL Invalidar CDN]**. Puede ver una lista de una o más direcciones URL generadas a partir de la plantilla creada y los recursos seleccionados. Utiliza la URL del servidor que aparece en &quot;Nombre del servidor publicado&quot; en Configuración general de la aplicación.

   Por ejemplo, con la plantilla de invalidación de CDN establecida en el paso anterior, supongamos que ha seleccionado una sola imagen de recurso de imagen denominada `Backpack_B`. Al pulsar **[!UICONTROL File]** > **[!UICONTROL Invalidate CDN]**, se genera la siguiente URL en la interfaz de usuario de Invalidación de CDN:
