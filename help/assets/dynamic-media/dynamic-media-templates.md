...
1. Haga clic en **más opciones** (![plantillas compatibles con actualizaciones en tiempo real](/help/assets/assets/three-dots.svg)) para editar o eliminar la capa.
...
1. En la vista Assets, haga clic en **[!UICONTROL Dynamic Media Assets]**.
