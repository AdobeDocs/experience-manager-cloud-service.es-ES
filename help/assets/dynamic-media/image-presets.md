...
1. Realice una de las acciones siguientes:
   ...
   * Para mostrar la ventana emergente, seleccione **[!UICONTROL URL]**, **[!UICONTROL Incrustar]** o **[!UICONTROL RESS]**.
   ...
   >[!NOTE]
   >
   >Si el recurso *y* el ajuste preestablecido de imagen aún no se ha publicado, la variable **[!UICONTROL URL]** (o los botones URL y RESS, si corresponde) no están disponibles.
   >
