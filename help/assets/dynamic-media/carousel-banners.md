...
La creación y modificación de contenido destacado en las pancartas promocionales puede llevar mucho tiempo, lo que limita la capacidad de publicar contenido nuevo rápidamente o de hacerlo más específico. Los letreros de carrusel permiten crear o modificar rápidamente letreros rotativos y añadir interactividad, como la vinculación de puntos interactivos, a los detalles del producto o a los recursos relacionados. Puede ofrecerlos en cualquier pantalla, lo que le permitirá comercializar contenido promocional más rápido.
...
1. [Identifique las variables](#identifying-hotspot-and-image-map-variables)  de puntos interactivos y mapas de imagen (solo para clientes que utilizan Adobe Experience Manager Assets + Dynamic Media)

   Inicio identificando variables dinámicas utilizadas por la implementación de vista rápida existente. Esto le ayuda a introducir los puntos interactivos y los datos de mapas de imagen correctamente durante el proceso de creación de letreros de carrusel en Recursos Experience Manager.
...
1. Opcional: [Cree un ajuste preestablecido de visualizador de conjuntos de carrusel](/help/assets/dynamic-media/managing-viewer-presets.md), según sea necesario.
   ...
   Si es un administrador, puede personalizar el comportamiento y el aspecto del carrusel creando su propio ajuste preestablecido de visor de carrusel. La principal ventaja es que puede reutilizar este ajuste preestablecido de visor personalizado para varios carruseles. Sin embargo, los usuarios pueden personalizar de forma opcional el comportamiento y la apariencia del carrusel directamente durante la creación del carrusel. Este enfoque es preferible cuando desea un diseño específico para un determinado carrusel.
...
El método consiste entonces en visitar diferentes áreas del sitio web existente donde se implementa la función de vista rápida. A continuación, déclencheur la vista rápida y capture la URL de Ajax que envía la página web para cargar los datos o el contenido de la vista rápida.
...
* Para ver todas las solicitudes HTTP salientes en Google Chrome, pulse F12 (Windows) o Comando-Opción-I (Mac) para abrir el panel de herramientas del desarrollador. Puntee en la ficha Red.
* En Firefox, puede activar el complemento Firebug pulsando F12 (Windows) o Comando-Opción-I (Mac). Utilice su ficha Red o la herramienta integrada Inspector y su ficha Red.
...
Durante este proceso, es importante visitar diferentes áreas del sitio web, con diferentes tipos y categorías de productos. El motivo es que las direcciones URL de vista rápida tienen partes comunes para una categoría de sitio web determinada, pero solo cambian si se visita un área diferente del sitio web.
...
Si ya ha cargado las imágenes que desea utilizar, avance al paso siguiente, [Creación de conjuntos de carrusel](#creating-carousel-sets). Las imágenes utilizadas en el carrusel deben cargarse después de habilitar Dynamic Media.
...
1. Puede cambiar el diseño visual y el comportamiento de los conjuntos de carrusel tocando o haciendo clic en las fichas Comportamiento y Aspecto y ajustando el aspecto de la pancarta de carrusel o el comportamiento de componentes específicos. Consulte [administración de ajustes preestablecidos de visor](/help/assets/dynamic-media/viewer-presets.md) para obtener más información sobre cómo utilizar el editor de visor.
   ...
   >[!NOTE]
   >
   >Para las pancartas de carrusel, puede ajustar lo siguiente:
...
Al agregar zonas interactivas o mapas de imagen, puede definirlos como una pantalla emergente de vista rápida, como un hipervínculo o como un fragmento de experiencia.

Consulte [Fragmento de experiencias](/help/sites-cloud/authoring/fundamentals/experience-fragments.md).

>[!NOTE]
>
>Las herramientas de uso compartido en medios sociales de la pancarta de carrusel no son compatibles cuando se incrusta el visor en un fragmento de experiencia.
>
...
Cuando termine de crear la pancarta de carrusel, puede utilizar la Previsualización para ver una representación de cómo la pancarta de carrusel aparece para los clientes.
...
1. Realice una de las acciones siguientes:
   ...
   * Para mapas de imagen: En la imagen, haga clic en y arrastre desde la esquina superior izquierda a la inferior derecha para crear el área del mapa de imagen. Puede ajustar el tamaño del mapa de imagen arrastrando las esquinas.

   Si es necesario, arrastre el punto interactivo o el mapa de imagen a una nueva ubicación. O bien, utilice las teclas de flecha del teclado para controlar la posición de una zona interactiva seleccionada. Añada más zonas interactivas o mapas de imagen según sea necesario.

   Para eliminar una zona interactiva o un mapa de imagen, pulse la pestaña **[!UICONTROL Acciones]**. Bajo el encabezado **[!UICONTROL Mapas y zonas interactivas]**, en la lista desplegable **[!UICONTROL Tipo seleccionado]**, seleccione el nombre del punto interactivo o mapa de imagen que desee eliminar. Pulse el icono **[!UICONTROL Papelera]** situado junto al menú y, a continuación, pulse **[!UICONTROL Eliminar]**.

1. En el campo de texto Nombre, escriba el nombre del punto interactivo o del mapa de imagen. Este nombre también aparece en la lista desplegable **[!UICONTROL Mapas y puntos interactivos]**. Proporcionar un nombre facilita la identificación del punto interactivo o mapa de imagen si decide cambiarlo en el futuro.
1. Realice una de las siguientes acciones en la ficha **[!UICONTROL Acciones]**:

   * Toque **[!UICONTROL vista rápida]**.

      * Si es cliente de Sitios Experience Manager <!-- and Ecommerce-->, toque el icono Selector de productos (lupa) para abrir la página Seleccionar producto. Para volver al Editor de letreros de carrusel, toque el producto que desee utilizar y, a continuación, toque la marca de verificación en la esquina superior derecha de la página.
...
1. Publique el conjunto de carrusel. La publicación crea el código incrustado o la URL que puede utilizar en la página del sitio web. Si es cliente de Sitios Experience Manager, agregue el conjunto de carrusel directamente a su página web.
...
* Reordene las diapositivas en el conjunto de carrusel.
...
1. Para editar el conjunto de carrusel, realice una de las siguientes acciones:
   ...
   * Para editar zonas interactivas o mapas de imagen, en la diapositiva adecuada, seleccione un punto interactivo o un mapa de imagen. En la ficha **[!UICONTROL Acciones]**, realice los cambios.
...
1. Para probar las acciones asociadas, toque las zonas interactivas o los mapas de imagen de la imagen.
...
1. En la lista **[!UICONTROL Visores]** del panel de la izquierda de la página, toque el nombre del ajuste preestablecido del visor de pancartas carrusel que desee utilizar.
1. Para probar las acciones asociadas, toque las zonas interactivas o los mapas de imagen de la imagen.
...
Después de cargar imágenes de letrero para crear un carrusel, añadir zonas interactivas o mapas de imagen, o ambos, en el letrero. Se ha publicado el conjunto de carrusel. Ya está listo para agregarlo a la página de sitio web existente.
...
1. Añada el código incrustado que ha copiado de Recursos Experience Manager en la página web.
El código incrustado copiado responde, de modo que se ajusta automáticamente al área de incrustación de la página.
...
El último paso de este proceso es integrar la pancarta de carrusel con una implementación de vista rápida existente en el sitio web. Cada implementación de vista rápida es única y se necesita un enfoque específico que generalmente involucre la asistencia de una persona de TI de primer nivel.
...
El proceso de construir la URL de vista rápida es opuesto al proceso utilizado para identificar las variables de zona interactiva y mapa de imagen que se han cubierto anteriormente.

Consulte [Identificación de variables de zona interactiva y mapa de imagen](#identifying-hotspot-and-image-map-variables).

El último paso para realizar el déclencheur de la URL de vista rápida y activar el panel vista rápida requiere, probablemente, la asistencia de una persona de TI del front-end del departamento de TI. Tienen los conocimientos para saber mejor cómo déclencheur con precisión la implementación de vista rápida desde el paso adecuado, teniendo una URL de vista rápida lista para usar.
