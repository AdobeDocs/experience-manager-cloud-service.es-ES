...
# Invalidar la caché de CDN mediante Dynamic Media {#invalidating-cdn-cache-for-dm-assets-in-aem-cs}
...
Consulte también [Información general de caché en Dynamic Media](https://helpx.adobe.com/experience-manager/scene7/kb/base/caching-questions/scene7-caching-overview.html).

**Para invalidar la caché de CDN mediante Dynamic Media:**

*Parte 1 de 2: Creación de una plantilla de invalidación de CDN*

1. En Adobe Experience Manager as a Cloud Service, vaya a **[!UICONTROL Tools]** > **[!UICONTROL Assets]** > **[!UICONTROL CDN Invalidation Template]**.
...
1. En Experience Manager como Cloud Service, vaya a **[!UICONTROL Tools]** > **[!UICONTROL Assets]** > **[!UICONTROL CDN Invalidation]**.
...
1. En la página **[!UICONTROL Invalidación de CDN]** - **[!UICONTROL Confirmar]**, en el cuadro de lista **[!UICONTROL URL]**, verá una lista de una o más direcciones URL generadas a partir de la plantilla de invalidación de CDN creada anteriormente y los recursos que acaba de agregar.
   ...
   Por ejemplo, si utiliza el ejemplo de Plantilla de invalidación de CDN que se mostró en los pasos anteriores, supongamos que ha añadido un único recurso denominado `spinset`. Cuando vaya a **[!UICONTROL Tools]** > **[!UICONTROL Assets]** > **[!UICONTROL CDN Invalidation]**, resultará en las siguientes cinco direcciones URL generadas en la interfaz de usuario **[!UICONTROL CDN Invalidation - Confirm]**:
...
| *No se ha introducido ninguna dirección URL para invalidar.* | Se produce si no hay direcciones URL presentes en la página **[!UICONTROL Invalidación de CDN]** - **[!UICONTROL Confirmar]** y selecciona **[!UICONTROL Enviar]**. |
