...
1. En la página de plantilla **[!UICONTROL Invalidación de]** CDN, realice una de las siguientes opciones según el escenario:
...
1. En la página **[!UICONTROL Invalidación]** de CDN: **[!UICONTROL Confirmar]** , en el cuadro lista de **[!UICONTROL URL]** , verá una lista de una o varias URL generadas a partir de la plantilla de invalidación de CDN que creó anteriormente y de los recursos que acaba de agregar.
   ...
   Por ejemplo, con el ejemplo de Plantilla de invalidación de CDN que se mostraba en los pasos anteriores, supongamos que ha agregado un único recurso denominado `spinset`. Al tocar **[!UICONTROL Herramientas > Recursos > Invalidación]** de CDN, se generan las siguientes cinco direcciones URL en la interfaz de usuario Invalidación de **[!UICONTROL CDN: Confirmar]** :
...
| *No se especificó ninguna dirección URL para invalidarla.* | Se produce si no hay direcciones URL presentes en la página Invalidación **[!UICONTROL de]** CDN: **[!UICONTROL Confirmar]** y toca **[!UICONTROL Enviar.]** |
