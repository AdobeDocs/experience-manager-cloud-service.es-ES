...
El trabajo con Dynamic Media no está disponible en la interfaz de usuario clásica. Consulte [Trabaje con Dynamic Media,](/help/assets/dynamic-media/dynamic-media.md) que cubre la interfaz de usuario táctil.
