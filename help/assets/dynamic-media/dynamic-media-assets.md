...
description: Dynamic Media ayuda a proporcionar bajo demanda recursos de marketing y mercadotecnia de rico contenido visual, escalados automáticamente para el consumo en la Web, dispositivos móviles y redes sociales. Con un conjunto de recursos de origen principal, Dynamic Media genera y ofrece varias variaciones de contenido enriquecido en tiempo real a través de su red global, escalable y optimizada para el rendimiento
...
El trabajo con Dynamic Media no está disponible en la interfaz de usuario clásica. Consulte [Trabajar con Dynamic Media,](/help/assets/dynamic-media/dynamic-media.md) que cubre la interfaz de usuario táctil.
