...
En la IU clásica, no es posible trabajar con Dynamic Media. Consulte [Uso de Dynamic Media](/help/assets/dynamic-media/dynamic-media.md), que describe la interfaz de usuario habilitada para el uso táctil.
