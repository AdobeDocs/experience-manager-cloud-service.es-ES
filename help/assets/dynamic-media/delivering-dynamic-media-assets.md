...
* [Envío de contenido HTTP2](/help/assets/dynamic-media/http2.md)
...
Consulte [HTTP/2 Entrega de contenido Preguntas](/help/assets/dynamic-media/scene7-http2faq.md) más frecuentes para obtener más información.
