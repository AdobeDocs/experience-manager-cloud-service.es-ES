...
En esta sección se describe cómo crear, modificar y administrar, en general, los ajustes preestablecidos de imagen. Puede aplicar un ajuste preestablecido de imagen a una imagen cada vez que la previsualización. Consulte [Aplicación de ajustes preestablecidos de imagen](/help/assets/dynamic-media/image-presets.md).
...
>
>*no* necesita publicar ajustes preestablecidos de imagen a medida que se publican automáticamente.
>
...
1. En el flujo de trabajo `DAM Update Asset`, el componente de proceso `Rasterize PDF/AI Image Preview Rendition` rasteriza la primera página del recurso original (utilizando la resolución configurada) en una representación `cqdam.preview.png`.
...
Toque en Adobe Experience Manager en la esquina superior izquierda y vaya a **[!UICONTROL Herramientas > Flujo de trabajo > Modelos]**. En la página Modelos de flujo de trabajo, seleccione **[!UICONTROL Recurso de actualización de DAM]** y, a continuación, en la barra de herramientas, toque **[!UICONTROL Editar]**. En la página de flujo de trabajo de recursos de actualización de DAM, toque con el doble el componente de proceso `Rasterize PDF/AI Image Preview Rendition` para abrir el cuadro de diálogo Propiedades del paso.
...
El componente de proceso `Rasterize PDF/AI Image Preview Rendition` tiene un máximo definido para garantizar que no cree imágenes demasiado grandes en la memoria. Estas imágenes de gran tamaño pueden desbordar la memoria proporcionada a la JVM (Máquina virtual Java). Se debe tener cuidado de proporcionar al JVM suficiente memoria para administrar el número configurado de flujos de trabajo paralelos, y cada uno de ellos tiene la posibilidad de crear una imagen con el tamaño máximo configurado.
...
El componente de proceso de Extracción de medios del flujo de trabajo `DAM Update Asset` ejecuta varios scripts extend preconfigurados para procesar archivos InDesign.
...
1. Toque el paso **[!UICONTROL Recursos de imagen de proceso de Dynamic Media]** y toque la ficha **[!UICONTROL Miniaturas]**. Cambie el tamaño de la miniatura, según sea necesario, y pulse **[!UICONTROL Aceptar]**.
...
### Aumento o disminución del número de ajustes preestablecidos de imagen que muestran {#increasing-or-decreasing-the-number-of-image-presets-that-display}
...
### Ajustes preestablecidos de imagen de publicación {#publishing-image-presets}
...
1. Seleccione un ajuste preestablecido y haga clic en **[!UICONTROL Eliminar]**. Dynamic Media confirma que desea eliminarlo. Toque **[!UICONTROL Eliminar]** para eliminar o toque **[!UICONTROL Cancelar]** para cancelar.
