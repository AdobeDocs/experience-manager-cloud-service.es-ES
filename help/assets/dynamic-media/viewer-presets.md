...
Consulte también [Publicar ajustes preestablecidos de visor](managing-viewer-presets.md#publishing-viewer-presets).
...
1. Abra el recurso y en el carril izquierdo y seleccione **[!UICONTROL Visualizadores]**.
   ...
   * El sistema muestra numerosos ajustes preestablecidos de visualizador al seleccionar Visualizadores en la **[!UICONTROL vista de detalles de un recurso]**. Puede aumentar el número de ajustes preestablecidos vistos. Consulte [Aumente el número de ajustes preestablecidos de visor que se muestran](managing-viewer-presets.md).
...
Para obtener las direcciones URL de los ajustes preestablecidos de visor, consulte [Vincular URL a la aplicación web](linking-urls-to-yourwebapplication.md).
