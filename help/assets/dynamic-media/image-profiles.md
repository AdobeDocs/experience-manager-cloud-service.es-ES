...
Tiene dos opciones de recorte de imagen entre las que elegir. También puede optar por automatizar la creación de muestras de color e imagen o conservar el contenido de recorte en las resoluciones de destino.
