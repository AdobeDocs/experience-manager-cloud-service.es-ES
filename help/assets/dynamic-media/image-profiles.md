...
| **[!UICONTROL Conservar el contenido de recorte en las resoluciones de destino]** | Mantener el recorte del contenido en la misma proporción de aspecto | Se utiliza cuando se crea un perfil de recorte inteligente.<br>Al desmarcar esta casilla, se genera nuevo contenido de recorte (manteniendo al mismo tiempo el punto focal) para una proporción de aspecto determinada en distintas resoluciones.<br>Si decide desmarcar esta casilla, asegúrese de que la resolución de imagen original es buena que las resoluciones que defina para su perfil de recorte inteligente.<br><br>Por ejemplo, supongamos que ha establecido las relaciones de aspecto en 600 x 600 (grande), 400 x 400 (media) y 300 x 300 (pequeña). <br>con **[!UICONTROL Conservar el contenido de recorte en las resoluciones de destino]** option *activado*, verá el mismo recorte en las tres resoluciones, lo que resultará en la siguiente salida de muestra de imágenes (solo para fines ilustrativos):<br>![Opción activada](/help/assets/dynamic-media/assets/preserve-checked.png)<br><br>con **[!UICONTROL Conservar el contenido de recorte en las resoluciones de destino]** option *sin marcar*, el contenido del recorte es nuevo para las tres resoluciones, lo que resulta en la siguiente salida de muestra de imágenes (solo para fines ilustrativos):<br>![Opción desmarcada](/help/assets/dynamic-media/assets/preserve-unchecked.png) |
