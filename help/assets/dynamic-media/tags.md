...
Consulte [Reglas](https://experienceleague.adobe.com/docs/experience-platform/tags/ui/rules.html) en la Guía del usuario de etiquetas del Experience Platform.
...
Consulte [Extensión del servicio de identidad de Experience Cloud](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/id-service/overview.html).
...
1. En el autor del Experience Manager, cerca de la esquina superior izquierda, seleccione el icono Herramientas (martillo) y vaya a **[!UICONTROL Cloud Services]** > **[!UICONTROL Configuraciones de etiquetas de Experience Platform]**.
