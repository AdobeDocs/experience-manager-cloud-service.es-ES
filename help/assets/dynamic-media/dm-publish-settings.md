...
description: Obtenga información sobre cómo configurar el programa de instalación de publicación de Dynamic Media para el servidor de imágenes, que abarca, entre otras cosas, la administración de color, la seguridad y las imágenes en miniatura.
