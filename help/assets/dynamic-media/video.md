...
1. En la página Tablero , a la derecha de **[!UICONTROL Google Cloud Platform]**, seleccione **[!UICONTROL Proyecto]** lista desplegable para abrir el **[!UICONTROL Seleccionar un proyecto]** para abrir el Navegador.
