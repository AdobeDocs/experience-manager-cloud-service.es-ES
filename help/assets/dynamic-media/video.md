...
1. ****
   ...
   * Create your own video encoding profile. __
   ...
   * Upload your primary source videos to the folders. When you add videos to the folder, they are encoded according to the video processing profile that you assigned to the folder.
      ...
      * [](/help/assets/manage-video-assets.md#upload-and-preview-video-assets)
      * [](/help/assets/file-format-support.md)
...
**** Este flujo de trabajo captura el historial de procesos de flujo de trabajo y la información de errores. [](#monitoring-video-encoding-and-youtube-publishing-progress) **** ****
...
| Tamaño | Proporción de aspecto | Minimum bit rate |
|--- |--- |--- |
...
**** Most source video is stored at a high resolution (for example, 1920 x 1080). For streaming purposes, source video is compressed to a smaller resolution (640 x 480 or smaller).
...
| Resolución | Altura (píxeles) | Screen size |
|--- |--- |--- |
...
| Video Type | Width x Height | Proporción de anchura | Height Ratio |
|--- |--- |--- |--- |
...
1. En el cuadro de diálogo Configuración de cuenta de YouTube, en el campo **[!UICONTROL Nombre de la aplicación]**, introduzca el ID del proyecto de Google.
   ...
   [](/help/assets/dynamic-media/video.md#configuring-google-cloud-settings)
...
>[!NOTE]
>
>Publish immediately does not automatically publish to YouTube. Cuando se configura Dynamic Media, hay dos opciones de publicación entre las que elegir: **[!UICONTROL Inmediata]** o **[!UICONTROL Después de la activación]**.
>
...
1. View video encoding progress in your assets folder:
   ...
   * **** Si hay un error, este mensaje se muestra en la misma columna.

   ![](assets/chlimage_1-430.png)

   Esta columna no se muestra de forma predeterminada. ************
...
** The following top metrics data are aggregated for all published videos across your entire website:
...
1. Use a third-party application or service to create your video caption/subtitle file.
   ...
   ******** [](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset)**** Internet Explorer, Chrome o Safari pueden reproducir el vídeo de forma predeterminada.
   ...
   <table>
     <tbody>
      <tr>
       ...
       <td>
       <ol>
       <li><i></i> Recuerde que las direcciones URL solo están disponibles para copiarse <i>después</i> de <i>publicar</i> los recursos por primera vez. <a href="/help/assets/dynamic-media/publishing-dynamicmedia-assets.md"></a></li>
       <li><strong></strong></li>
