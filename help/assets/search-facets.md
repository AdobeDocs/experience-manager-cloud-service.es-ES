...
1. Toque **[!UICONTROL Eliminar]** ![icono de eliminar](assets/do-not-localize/deleteoutline.png) en la barra de herramientas.
...
| Eliminar | Leer, escribir y eliminar permisos en el nodo `/apps` de CRX. |
| Vista previa | Leer, escribir y eliminar permisos en el nodo `/var/dam/content` de CRX. Además, los permisos de lectura y escritura en el nodo `/apps`. |
