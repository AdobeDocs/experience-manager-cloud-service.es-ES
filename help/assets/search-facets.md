...
1. Haga clic en **[!UICONTROL Preview]** ![preview](assets/preview.png) para generar una previsualización del panel Filtros tal como aparece después de agregar el predicado.
...
1. Para cerrar la vista previa, haga clic en **[!UICONTROL Close]** ![close](assets/do-not-localize/close_icon.png) en la esquina superior derecha de la vista previa.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>El predicado de búsqueda realiza una búsqueda de texto completo en todo un nodo de recursos. Se asigna con el operador <code>jcr</code>:<code>contains</code> . Puede especificar una ruta relativa si desea realizar una búsqueda de texto completo en una parte específica del nodo de recursos.</td>
   <td>
    <ul>
     <li>Etiqueta</li>
...
1. Pulse **[!UICONTROL Eliminar]** ![icono de eliminación](assets/do-not-localize/deleteoutline.png) en la barra de herramientas.
...
| Acción | Permiso |
|---|---|
| Editar | Permisos de lectura y escritura en el nodo `/apps` en CRX. |
| Eliminar | Permisos de lectura, escritura y eliminación en el nodo `/apps` en CRX. |
| Vista previa | Permisos de lectura, escritura y eliminación en el nodo `/var/dam/content` en CRX. Además, permisos de lectura y escritura en el nodo `/apps`. |
