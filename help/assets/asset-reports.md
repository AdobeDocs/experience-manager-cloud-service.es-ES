...
* Si la variable [!UICONTROL Informe de uso del disco] no genera y si está utilizando [!DNL Dynamic Media], asegúrese de que todos los recursos se realizan correctamente. Para resolverlo, vuelva a procesar los recursos y vuelva a generar el informe.
