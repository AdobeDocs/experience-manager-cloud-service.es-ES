...
+ [[!DNL Assets] como un [!DNL Cloud Service]](/help/assets/home.md)
+ [Información general y novedades](overview.md)
+ [Cambios notables  [!DNL Assets] a [!DNL Cloud Service]](assets-cloud-changes.md)
...
+ Configurar, administrar y ampliar [!DNL Assets] {#admin}
   ...
   + [Autenticación para Consultas GraphQL de AEM remoto en fragmentos de contenido](content-fragments/graphql-authentication-content-fragments.md)
...
+ Fragmentos de contenido {#content-fragments}
   ...
   + [Envío sin cabeza con fragmentos de contenido y GraphQL](content-fragments/content-fragments-graphql.md)
...
+ Dynamic Media {#dynamicmedia}
   ...
   + [Fin de vida útil de los visores de Flash](dynamic-media/flash-viewers-eol.md)
