...
### ¿Puedo configurar los campos que son obligatorios u opcionales al cargar recursos en AEM Assets Content Hub? {#available-fields-while-uploading-assets-to-content-hub}

Los administradores pueden utilizar la interfaz de usuario de configuración para definir los campos obligatorios u opcionales al cargar recursos en AEM Assets Content Hub.
