...
| Usuario DAM | Remoto | `Authors` | Autor función en el remoto [!DNL Experience Manager] implementación. Busque y examine recursos en recursos conectados utilizando [!UICONTROL Buscador de contenido]. |
...
>[!NOTE]
>
>Las actualizaciones de los recursos en DAM remoto solo están disponibles para la implementación de Sites si las implementaciones remotas de DAM y Sites están as a Cloud Service por el Experience Manager.
