...
* **Objetivo:** Defina por qué captura los metadatos. Especifique el valor que agrega a los procesos, sistemas u organización.

* **Plan de accesibilidad:** Cree un plan para que los metadatos sean fácilmente accesibles y reconocibles. Explique quién lo va a utilizar y las herramientas o métodos que se van a utilizar.
...
Por ejemplo, en lugar de usar nombres duplicados como *campaign_image_001* y *campaign_image_002*, implemente una convención de nombres sistemática como *event_promotion* y *product_launch*, garantizando una identificación clara y ordenada.

* **Utilice vocabularios controlados de forma eficaz:** Implemente vocabularios controlados empleando términos estandarizados para las etiquetas. Obtenga información sobre cómo implementar [AEM Marco de etiquetado de](/help/implementing/developing/introduction/tagging-framework.md) efectivamente.  <br>
...
* **Optimización de palabras clave:** Mejore la capacidad de búsqueda de metadatos optimizando las palabras clave asociadas con los recursos. Puede mejorar la relevancia de las palabras clave para recursos concretos en la [!UICONTROL Administrador de recursos] siguiendo estos pasos:
   ...
   1. Vaya a **[!UICONTROL Avanzadas]** y haga clic en **[!UICONTROL Añadir]** en el **[!UICONTROL Elevar para palabras clave de búsqueda]**. <br>Debe utilizar el esquema de metadatos predeterminado para elevar las palabras clave de búsqueda.
...
Busque el recurso con las palabras clave agregadas. El recurso aparece entre los resultados de búsqueda principales.
  ...
  Obtenga información sobre cómo [aumentar la búsqueda en Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/search-and-discovery/search-boost.html).

* **Campos de metadatos personalizados:** Personalice los campos de metadatos para capturar información adicional acerca de los recursos. Por ejemplo, agregue campos específicos para los detalles del proyecto, la información de copyright o cualquier otro dato relevante que mejore las capacidades de búsqueda. Aprender [cómo editar o añadir metadatos personalizados](meta-edit.md) en Experience Manager Assets.
