...
La fecha de la última versión, 1.9.8, de [!DNL Workfront for Experience Manager enhanced connector] es el 3 de marzo de 2023.
...
>[!IMPORTANT]
>
>El Adobe recomienda [actualice a la última versión 1.9.8](../assets/update-workfront-enhanced-connector.md) de la [!DNL Workfront for Experience Manager enhanced connector].
