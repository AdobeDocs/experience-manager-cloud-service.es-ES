...
>[!IMPORTANT]
>
>Adobe le recomienda [actualizar a la versión más reciente 1.9.14](/help/assets/workfront-connector-install.md) de [!DNL Workfront for Experience Manager enhanced connector].
