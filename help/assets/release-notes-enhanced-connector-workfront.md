...
La fecha de la última versión 1.9.21 de [!DNL Workfront for Experience Manager enhanced connector] es el 25 de junio de 2025.
...
* Se ha corregido una fuga de conexión en las llamadas a Workfront API.
