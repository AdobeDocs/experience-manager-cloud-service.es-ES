...
description: Publish o cancelar la publicación de recursos en Experience Manager Assets, Dynamic Media y Brand Portal
mini-toc-levels: 1
...
Puede publicar o cancelar la publicación de recursos en el nivel de recursos o carpetas mediante la opción **[!UICONTROL Quick Publish]** o **[!UICONTROL Administrar publicación]** disponible en la interfaz [!DNL Experience Manager Assets]. Si realiza las modificaciones posteriores al recurso o la carpeta originales en [!DNL Experience Manager Assets], los cambios no se reflejarán en la instancia de publicación hasta que vuelva a publicar desde [!DNL Experience Manager Assets]. Garantiza que los cambios en curso no estén disponibles en la instancia de publicación. Solo los cambios aprobados publicados por un administrador están disponibles en la instancia de publicación.

* [Recursos de Publish con Quick Publish](#quick-publish)
* [Recursos de Publish usando Administrar publicación](#manage-publication)
* [Recursos de Publish más adelante](#publish-assets-later)
* [Recursos de Publish a Dynamic Media](#publish-assets-to-dynamic-media)
...
* [!UICONTROL Acciones]
   * `Publish`: recursos y carpetas de Publish al destino seleccionado
   * `Unpublish`: cancelar la publicación de recursos y carpetas desde el destino

* [!UICONTROL Destino]
   * `Publish`: recursos y carpetas de Publish a [!DNL Experience Manager Assets] (`AEM`)
   * `Dynamic Media`: recursos de Publish a [!DNL Dynamic Media]
   * `Brand Portal`: recursos y carpetas de Publish a [!DNL Brand Portal]

* [!UICONTROL Programación]
   * `Now`: recursos de Publish inmediatamente
   * `Later`: recursos de Publish basados en la fecha u hora `Activation`
...
En la tabla siguiente se explica cómo se produce la publicación en función del **[!UICONTROL destino]** y del **[!UICONTROL modo Dynamic Media Publish]** definidos:

| [!UICONTROL Destino] | [!UICONTROL Modo Dynamic Media Publish] | [!UICONTROL Publish Target] | Contenido permitido |
| --- | --- | --- | --- |
...
![Publish a Dynamic Media](assets/manage-publication-dynamic-media.png)
...
1. Haga clic en **[!UICONTROL Publish]** de **[!UICONTROL Action]** y, a continuación, seleccione el **[!UICONTROL destino]** en el que desea publicar el contenido.
...
Solo se publican los recursos en [!DNL Dynamic Media]. Sin embargo, el comportamiento de publicación difiere según las propiedades de la carpeta. Una carpeta puede tener **[!UICONTROL Dynamic Media Publish mode]** configurado para la publicación selectiva, que puede ser cualquiera de las siguientes:

* `Selective Publish`
* `Immediate`
* `Upon Activation`

El proceso de publicación de los modos **[!UICONTROL Inmediato]** y **[!UICONTROL Tras la activación]** es consistente, pero diferente para **[!UICONTROL Publish selectivo]**. Consulte [Configurar la publicación selectiva en el nivel de carpeta en Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/selective-publishing.html?lang=es). Después de configurar la publicación selectiva en una carpeta, puede realizar cualquiera de las siguientes acciones:
...
* [Recursos de Publish a Dynamic Media o al Experience Manager mediante Quick Publish](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/selective-publishing.html?lang=en#quick-publish-aem-dm)
