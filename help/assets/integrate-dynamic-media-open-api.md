---
title: Integración del Asesor de contenido con la API abierta de Dynamic Media
description: Integre el Asesor de contenido con varias aplicaciones de Adobe, que no sean de Adobe y de terceros.
role: Admin, User
...
# Integración de Dynamic Media con funciones de OpenAPI {#integrate-dynamic-media-open-apis}

El Asesor de contenido le permite integrarse utilizando varias aplicaciones de Adobe para permitirles trabajar juntos sin problemas.

## Requisitos previos {#prereqs-polaris}

Utilice los siguientes requisitos previos si integra el Asesor de contenido con Dynamic Media con las capacidades de OpenAPI:

* [Métodos de comunicación](/help/assets/content-advisor-properties.md#prereqs)
...
La integración del Asesor de contenido con el proceso OpenAPI de Dynamic Media implica varios pasos que incluyen la creación de una URL de Dynamic Media personalizada o una URL de Dynamic Media lista para elegir, etc.

### Integración del Asesor de contenido para Dynamic Media con las funciones de OpenAPI {#integrate-dynamic-media}
...
Esta configuración le permite ver todos los recursos aprobados sin carpetas o como una estructura plana. Para obtener más información, vaya a la propiedad `aemTierType` en [Propiedades del Asesor de contenido](/help/assets/content-advisor-properties.md).
