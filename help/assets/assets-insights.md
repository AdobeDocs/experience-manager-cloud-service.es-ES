...
1. Si la autenticación se realiza correctamente, los grupos de informes aparecen en la lista desplegable. Seleccione el Adobe Analytics **[!UICONTROL Grupo de informes]** de donde desee que Assets Insights recupere los datos. Haga clic en **[!UICONTROL Agregar]**.
