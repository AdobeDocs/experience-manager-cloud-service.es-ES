...
1. Introduzca un título para el perfil de metadatos, por ejemplo Metadatos de ejemplo, y toque **[!UICONTROL Enviar]**. Se muestra el formulario de edición para el perfil de metadatos.
...
1. Puntee **[!UICONTROL Listo]**. El perfil de metadatos se agrega a la lista de perfiles de la página Perfiles **[!UICONTROL de]** metadatos.
...
1. Seleccione la ficha Perfiles **[!UICONTROL de]** metadatos, seleccione el perfil en el menú desplegable y toque **Guardar]**. Las carpetas que ya tienen un perfil asignado se indican mediante la visualización del nombre del perfil directamente debajo del nombre de la carpeta.
...
## Eliminación de un perfil de metadatos de carpetas {#removing-a-metadata-profile-from-folders}
