...
>[!NOTE]
Tanto la biblioteca de carga de aem como la herramienta de línea de comandos utilizan la función [biblioteca node-httptransfer](https://github.com/adobe/node-httptransfer/)
