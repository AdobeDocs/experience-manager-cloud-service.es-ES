...
Puede definir las [propiedades](#asset-selector-properties.md) del Selector de recursos en el archivo `index.html` para personalizar la visualización del Selector de recursos en la aplicación.
