...
En la siguiente sección se describe cómo configurar manualmente los recursos de Experience Manager como un [!DNL Cloud Service] con Brand Portal mediante la consola de Adobe Developer.
