...
La API de Adobe Experience Manager as a Cloud Service (AEM) GraphQL utilizada con los fragmentos de contenido se basa principalmente en la API estándar de código abierto de GraphQL.
