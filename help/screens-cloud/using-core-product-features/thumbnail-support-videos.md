...
description: En esta página se describe cómo añadir compatibilidad con miniaturas para vídeos en Screens as a Cloud Service.
index: true
...
>[!IMPORTANT]
>**Requisitos previos**
>Antes de aprender a utilizar miniaturas para vídeos, asegúrese de aprender a crear representaciones de vídeo para canales en proyectos de Screens as a Cloud Service. Consulte [Creación de representaciones de vídeo en Screens as a Cloud Service](/help/screens-cloud/configuring/creating-screens-video-renditions-cloud-service.md).
