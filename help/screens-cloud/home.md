...
# AEM Screens como Cloud Service {#aem-screens-as-a-cloud-service-guide}

En esta página se muestran los recursos informativos relacionados con AEM Screens as a Cloud Service.

>[!NOTE]
>Para AEM Screens con AEM 6.5, consulte la [Guía del usuario de AEM Screens](https://experienceleague.adobe.com/docs/experience-manager-screens/user-guide/aem-screens-introduction.html?lang=en).
...
* [Crear un proyecto e iniciar la creación de contenido](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/screens-as-cloud-service/create-content/creating-projects-screens-cloud.html?lang=en)
