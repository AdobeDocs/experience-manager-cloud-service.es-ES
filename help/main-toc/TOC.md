...
+ Forms {#forms}
   ...
   + Integrar {#integrate}
      ...
      + Modelo de datos de formulario {#use-form-data-model}
         ...
         + [Integración de aplicaciones de Salesforce con el flujo de credenciales de cliente de OAuth 2.0](/help/forms/oauth2-client-credentials-flow-for-server-to-server-integration.md)
   ...
   + Formularios adaptables {#adaptive-forms-authoring}
      ...
      + Creación de formularios adaptables: componentes principales {#authoring-adaptive-forms-core-components}
         + Creación de un formulario adaptable {#create-an-adaptive-form-on-forms-cs}
            ...
            + [Temas de muestra, plantillas y modelos de datos de formulario en componentes principales](/help/forms/sample-themes-templates-form-data-models-core-components.md)
