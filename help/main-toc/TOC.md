...
+ IA en AEM {#ai-in-aem}
   ...
   + Agentes comerciales de AEM {#business-agents}
      + [Información general](/help/ai-in-aem/agents/overview.md)
      + Agente de producción {#production}
         + [Información general](/help/ai-in-aem/agents/production/overview.md)
         + [Aptitud para la creación de comunicaciones interactivas](/help/ai-in-aem/agents/production/communications-creation.md)
      ...
      + Agente de optimización de contenido {#content-optimization}
         + [Uso del agente de optimización de contenido](/help/ai-in-aem/agents/content-optimization/using.md)
      + Agente de detección {#discovery}
         + [Usar el agente de detección](/help/ai-in-aem/agents/discovery/using.md)
