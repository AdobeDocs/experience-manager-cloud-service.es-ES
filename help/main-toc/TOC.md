...
+ Notas de la versión {#release-notes}
   ...
   + Notas de la versión de Cloud Manager {#cloud-manager}
      ...
      + 2025 {#2025}
         + [Notas de la versión 2025.1.0](/help/implementing/cloud-manager/release-notes/2025/2025-1-0.md)
      + 2024 {#2024}
         + [Notas de la versión 2024.12.0](/help/implementing/cloud-manager/release-notes/2024/2024-12-0.md)
...
+ Edge Delivery Services {#edge-delivery}
   ...
   + Creación de formularios {#build-forms}
      ...
      + WYSIWYG {#universal-editor}
         ...
         + [Crear componentes personalizados](/help/edge/docs/forms/universal-editor/create-custom-component)
...
+ Implementación {#implementing}
   ...
   + Usar Cloud Manager {#using-cloud-manager}
      ...
      + Asignaciones de dominio {#cdn-configurations}
         ...
         + [Administrar asignaciones de dominio](/help/implementing/cloud-manager/cdn-configurations/manage-cdn-config.md)
