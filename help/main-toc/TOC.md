   ...
   + Formularios adaptables {#adaptive-forms-authoring}
      ...
      + Componentes principales {#authoring-adaptive-forms-core-components}
         + Crear un formulario adaptable {#create-an-adaptive-form-on-forms-cs}
            ...
            + [Etiquetas de marcado HTML compatibles en el documento de registro](/help/forms/html-markup-tags-support-in-document-of-record.md)
...
+ Comunicación interactiva {#interactive-communication}
   ...
   + Asociar IU {#associateui}
      ...
      + [Generar comunicaciones personalizadas con la interfaz de usuario asociada](/help/forms/interactive-communication/invoke-associate-ui.md)
