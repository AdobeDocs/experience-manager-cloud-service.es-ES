---
title: 'Opcional: creación de aplicaciones de una sola página (SPA) con AEM'
...
En esta continuación opcional del [Recorrido para desarrolladores AEM sin encabezado,](overview.md) aprenderá cómo AEM combina la entrega sin encabezado con funciones tradicionales de CMS de pila completa y cómo puede crear SPA editables con el marco de trabajo del editor de SPA de AEM, así como integrar SPA externas, permitiendo la funcionalidad de edición necesaria.
...
* Comprender cómo se debe implementar o no la representación del lado del servidor.

## Condiciones y requisitos previos {#requirements-prerequisites}

Antes de empezar a trabajar con las SPA en AEM hay una serie de requisitos.
...
El desarrollo de aplicaciones de una sola página en AEM supone que el desarrollador front-end sigue las prácticas recomendadas estándar al crear una SPA. AEM SPA AEM Si, como desarrollador front-end, sigue estas prácticas recomendadas generales, así como algunos principios específicos de la, su se pone en funcionamiento con las funciones de creación de contenido de y de las que dispone.
...
Si tiene una SPA existente, AEM permite integrarlo en AEM para que sea visible para los autores de contenido en el editor de AEM. Esto puede resultar muy útil para ver el contenido que están creando mediante fragmentos de contenido en el contexto de la aplicación final en la que se consume.
...
* [Procesamiento en el lado del servidor](/help/implementing/developing/hybrid/ssr.md): cómo configurar la renderización del lado del servidor (SSR) para las SPA de AEM
* [Documentos de referencia de la SPA](/help/implementing/developing/hybrid/reference-materials.md): referencias de la API de JavaScript y vínculos a los proyectos de GitHub de SPA en AEM de código abierto
