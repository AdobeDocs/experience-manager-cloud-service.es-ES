...
En el documento anterior del recorrido de traducción sin AEM, [Configurar conector de traducción](configure-connector.md) aprendió sobre el marco de traducción en AEM. Ahora debería hacer lo siguiente:
...
Este documento le ayuda a comprender cómo utilizar AEM proyectos de traducción junto con el conector para traducir contenido. Después de leer este documento, debería poder hacer lo siguiente:
