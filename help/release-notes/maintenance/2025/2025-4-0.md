...
* GRANITE-55781: evitar la reconfiguración redundante del abono de los usuarios.
...
* SITES - 25130: componentes principales de la versión 2.27.0.
...
[El editor de SPA](/help/implementing/developing/hybrid/introduction.md) ha quedado obsoleto para nuevos proyectos a partir de la versión 2025.4.0. El Editor SPA sigue siendo compatible con los proyectos existentes, pero no debe utilizarse para nuevos proyectos.
