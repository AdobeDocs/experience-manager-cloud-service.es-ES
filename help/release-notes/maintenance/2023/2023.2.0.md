...
A continuación se resumen las mejoras continuas para la 11873 de la versión de mantenimiento, que se publicó el 3 de mayo de 2023. Esta versión de mantenimiento es una actualización de la versión de mantenimiento 11835 anterior.
...
- GRANITE-42939: agregue anotaciones y advertencias de desaprobación al código del servidor oauth
...
- GRANITE-4388: se corrigió la degradación del rendimiento después de un gran número de escrituras de recursos DAM en Mongo
...
- ASSETS-21648: se ha corregido un problema de permisos con la funcionalidad Relacionada con recursos
...
A continuación se resumen las mejoras continuas para la 11835 de la versión de mantenimiento, que se publicó el 19 de abril de 2023. Esta versión de mantenimiento es una actualización de la versión de mantenimiento 11382 anterior.
...
- SITES-7796: capacidad del autor de contenido para publicar el fragmento de contenido, con sus variaciones respectivas, al exportarlo a Target
