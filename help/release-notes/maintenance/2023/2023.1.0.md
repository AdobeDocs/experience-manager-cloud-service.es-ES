...
En la siguiente sección se describen las rutas de la versión técnica para la versión de mantenimiento de Experience Manager as a Cloud Service asociada a la activación de funcionalidades 2023.1.0.
...
|---|---|---|
| Componentes principales de WCM de AEM | Versión 2.21.2 | [GitHub](https://github.com/adobe/aem-core-wcm-components) |
