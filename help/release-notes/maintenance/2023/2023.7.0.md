...
- DXML-10093: AEM Guides: Compatibilidad para conectar con fuentes de datos externas e insertar datos en temas de dita
...
- SITES-12465: Fragmentos de experiencias, las teclas de dirección no funcionan en el cuadro de diálogo del componente Fragmento de experiencia
...
- FORMS AEM-8300: Cuando un usuario intenta delegar una tarea después de abrirla, la respuesta delegada vuelve a cargar la tarea, en lugar de abrir la interfaz de usuario de la Bandeja de entrada AEM del usuario.
