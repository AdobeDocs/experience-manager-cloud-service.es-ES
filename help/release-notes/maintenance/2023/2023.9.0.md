...
- FORMS-10652: Las variables no se rellenan en la lista desplegable de selección de variables. Por lo tanto, los usuarios no pueden asignar variables en un paso del flujo de trabajo.
