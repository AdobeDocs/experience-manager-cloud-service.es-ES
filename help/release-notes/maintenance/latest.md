...
* ASSETS-31445: funciones de plantillas iniciales de Dynamic Media
* ASSETS-40399: configuración de cola de transcripción automática de DM actualizados
* ASSETS-40873: permitir que el máximo de filas de metadatos exportadas se establezca mediante la configuración OSGI

### Problemas solucionados {#fixed-issues-17258}

* ASSETS-30613: reemplazar recurso no elimina ni añade recurso en el nuevo nivel de entrega
* ASSETS-31882: está prohibido acceder al archivo de manifiesto de streaming en el autor
* ASSETS-39598: la importación masiva no puede eliminar recursos con caracteres especiales en el nombre del back-end S3
* CNTBF-209: mejoras en la cancelación de trabajos de reflujo
* SCRNS-3762: mejorar playerLogger en el canal de secuencia para colocar registros en la consola al previsualizar el canal en el explorador
