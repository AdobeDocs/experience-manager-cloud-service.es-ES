...
## Versión 17882 {#release-17882}

A continuación se resumen las mejoras continuas para la versión de mantenimiento 17882, que se publicó el miércoles, 24 de septiembre de 2024. La versión de mantenimiento anterior fue la 17689.
...
### Problemas solucionados {#fixed-issues-17882}
...
* SITES - 2864: Accesibilidad: la función de arrastrar y soltar no es accesible mediante el teclado.

### Problemas conocidos {#known-issues-17882}
...
### Características y API obsoletas {#deprecated-17882}
...
### Correcciones de seguridad {#security-17882}
...
### Tecnologías integradas {#embedded-tech-17882}
