...
* ASSETS-35923: `UnsupportedClassVersionError` en el paso de generación de canalización de CM después de actualizar la versión `aem-sdk-api` a `2024.2.15262.20240224T002940Z-231200`. **Requiere la acción del cliente para establecer la versión de CM Java en 11**, consulte [Entorno de compilación / Configuración de la versión del JDK de Maven](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/build-environment-details.md#alternate-maven-jdk-version).
