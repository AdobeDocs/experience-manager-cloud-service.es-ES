...
La nueva versión de aem-sdk-api contiene clases compiladas con un destino Java 11, que no es compatible con la versión 1.8 del JDK predeterminado del entorno de compilación de Cloud Manager. Esta actualización requiere que Maven se ejecute con JDK 11.
...
* CQ-4355889 - Campaign - Segmentación - La solicitud de creación de público falla con la configuración de IMS.
...
* GUIDES-14968: el botón de navegación global no funciona y el panel de control no se puede cargar.
