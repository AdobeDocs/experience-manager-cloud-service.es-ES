...
* SITES-20149: RTC: `[cq-wcm-launches-core]` Exportar nueva API para inicios para CF.
* SITES-20150: RTC: `[cq-command]` Agregue nuevos métodos a la API existente.
...
* SITES-20342: `[Backend]` Publicar en el nivel de carpeta: agregue un filtro solo para publicar CF.
...
* SITES-20656: `[BE]` Proporcione la opción para que coincida con las mayúsculas y minúsculas al reemplazar una cadena.
* SITES-20666: La configuración del experimento debe desactivarse de forma predeterminada durante la creación.
* SITES-20752: `[cq-wcm-core]` lanzamientos de Apple para FQ.
...
* SITES-20947: `[persistence]` recuperar subtarea por ID de fragmento de contenido.
* SITES-21012: Combinar el esquema de metadatos del modelo con el producto.
* SITES-21043: `[CF][launches]` mejoras de rendimiento de puerto lateral en Cloud Service.
* SITES-21044: `[CF][launches]`: implementación de carga útil de edición asincrónica de puerto lateral en Cloud Service.
...
* SITES-11727: `[GQL]` Faltan datos en la hidratación completa de las referencias de fragmentos de contenido.
