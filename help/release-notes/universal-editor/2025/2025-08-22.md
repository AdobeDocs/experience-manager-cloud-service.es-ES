...
Estas son las notas de la versión del 22 de agosto de 2025 del Editor universal.
...
* Nuevas características para [primeros usuarios del RTE](#new-rte)
   * El título del vínculo ahora está disponible en el cuadro de diálogo del vínculo.
   * Ahora está disponible la opción de desvincular.
...
* [La característica de deshacer y rehacer que adoptó por primera vez](#undo-redo) ya no activa una recarga de página cuando se añade un componente mediante una operación de deshacer o rehacer.
