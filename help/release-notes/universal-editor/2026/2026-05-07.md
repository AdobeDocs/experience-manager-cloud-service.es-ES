...
* Se corrigió un problema en el cual la administración del lado del servidor de la operación `add` iteraba el valor de cadena, tratándolo como un objeto en lugar de como un parche.
