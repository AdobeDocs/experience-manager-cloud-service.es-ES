---
title: Notas de la versión de Adobe Experience Manager (AEM) como servicio de nube.
description: 'Notas de la versión de Adobe Experience Manager (AEM) como servicio de nube. '
...
| Producto | Adobe Experience Manager como servicio de nube |
|---|---|
| Versión | 2020.01.0 |
| Tipo | Actualización continua |
| Fecha de disponibilidad | Actualización continua |

## Información de versión clave {#key-articles}

* [Novedades](what-is-new.md)
* [Cambios notables](aem-cloud-changes.md)
