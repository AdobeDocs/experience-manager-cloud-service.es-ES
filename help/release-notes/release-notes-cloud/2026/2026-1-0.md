---
title: Notas de la versión 2026.1.0 de la versión de  [!DNL Adobe Experience Manager]  as a Cloud Service.
description: Notas de la versión 2026.1.0 de la versión de  [!DNL Adobe Experience Manager]  as a Cloud Service.
...
# Notas de la versión 2026.1.0 para [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

En la siguiente sección se describen las notas de la versión de funciones de la versión 2026.1.0 de [!DNL Experience Manager] as a Cloud Service.
