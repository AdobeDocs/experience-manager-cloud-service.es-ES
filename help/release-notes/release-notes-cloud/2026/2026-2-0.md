---
title: Notas de la versión 2026.2.0 de  [!DNL Adobe Experience Manager] as a Cloud Service.
description: Notas de la versión 2026.2.0 de  [!DNL Adobe Experience Manager] as a Cloud Service.
...
# Notas de la versión 2026.2.0 para [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

En la siguiente sección se describen las notas de la versión de la característica 2026.2.0 de [!DNL Experience Manager] as a Cloud Service.
...
La fecha de lanzamiento de [!DNL Adobe Experience Manager] como [!DNL Cloud Service] versión de característica actual (2026.2.0) es el 3 de marzo de 2026. La próxima versión de la funcionalidad (2026.3.0) está planificada para el 26 de marzo de 2026.
...
Eche un vistazo al vídeo Información general sobre la versión de febrero de 2026 para ver un resumen de las funciones añadidas en la versión 2026.2.0:
