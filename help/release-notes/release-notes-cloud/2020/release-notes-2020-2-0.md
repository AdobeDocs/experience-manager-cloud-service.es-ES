...
description: '[!DNL Adobe Experience Manager] Notas de la versión de as a Cloud Service para 2020.2.0.'
...
* Los vínculos Información general, Entornos y Actividad a veces estaban disponibles en la página de destino de Cloud Manager.
