...
* Las previsualizaciones de documentos nativas y de alta fidelidad de PDF ya están disponibles en Brand Portal. Ver [descripción general del visor de documentos](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/introduction/whats-new.html?lang=es#doc-viewer).
