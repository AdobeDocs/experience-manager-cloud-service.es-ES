...
* [[!DNL Adobe Asset Link] v3.0](https://helpx.adobe.com/es/enterprise/using/adobe-asset-link.html) para  [!DNL Adobe Photoshop],  [!DNL Adobe Illustrator],  [!DNL Adobe InDesign] y  [[!DNL Adobe Asset Link] v2.0](https://helpx.adobe.com/enterprise/using/adobe-asset-link-for-xd.html) para  [!DNL Adobe XD] está disponible. Proporciona:
...
* La [herramienta de ingesta masiva de activos](/help/assets/add-assets.md#asset-bulk-ingestor) permite agregar metadatos durante una ingesta masiva.
...
* [!DNL Experience Manager Assets] incrusta el visor de PDF para previsualizar los formatos de documento admitidos. Está alimentado por [!DNL Adobe Document Cloud]. Esta función permite a los usuarios previsualizar archivos PDF y otros archivos de varias páginas sin ningún procesamiento complejo. Esto mejora la paridad de las funciones con [!DNL Experience Manager] 6.5. Los controles disponibles en la vista previa son: zoom, navegación a páginas, desacoplamiento de controles y visualización en pantalla completa. El visor de PDF integrado es compatible con los formatos de archivo AI, DOCX, INDD, PDF y PSD. Puede realizar comentarios sobre el recurso en sí, pero no se admiten comentarios y anotaciones en el archivo PDF.
...
* Puede aplicar directamente un esquema de metadatos a una carpeta de sus [!UICONTROL Propiedades].
...
### Nuevas funciones en [!DNL Forms] {#what-is-new-forms}

* Los administradores de Forms pueden filtrar columnas personalizadas en AEM Bandeja de entrada.
* Los desarrolladores de Forms pueden utilizar el editor de temas y la capa de estilo del editor de formularios adaptables para aplicar estilo al componente captcha.
...
* Se ha añadido la acción de mover para ayudar a cambiar un archivo PDF o XDP de una carpeta a otra.
* Se ha reducido el tiempo de carga y se ha mejorado el rendimiento del editor de formularios adaptables y del editor de temas.
...
* Cuando se envía un formulario que contiene un campo de carga HTML estándar desde un dispositivo iOS de Apple, a veces el contenido del archivo no se envía y se recibe un archivo de 0 bytes en el otro extremo. [FB9117687](https://feedbackassistant.apple.com/feedback/9117687)
