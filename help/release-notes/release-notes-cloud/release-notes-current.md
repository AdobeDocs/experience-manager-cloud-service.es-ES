...
La fecha de lanzamiento de la versión de funcionalidad actual de [!DNL Adobe Experience Manager] as a [!DNL Cloud Service] (2023.1.0) es el 9 de febrero de 2023. La próxima versión de la función (2023.2.0) está planificada para el 12 de abril de 2023.
