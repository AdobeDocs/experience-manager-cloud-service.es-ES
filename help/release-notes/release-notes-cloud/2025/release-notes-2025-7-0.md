---
title: Notas de la versión 2025.7.0 de la versión de  [!DNL Adobe Experience Manager]  as a Cloud Service.
...
# Notas de la versión 2025.7.0 para [!DNL Adobe Experience Manager] as a Cloud Service {#release-notes}

En la siguiente sección se describen las notas de la versión de funciones de la versión 2025.7.0 de [!DNL Experience Manager] as a Cloud Service.
...
El [servicio de envío de formularios](/help/forms/forms-submission-service.md). le permite almacenar sin problemas datos de los envíos de formularios adaptables directamente en plataformas de hoja de cálculo populares, como Google Sheets, Microsoft OneDrive o SharePoint. Esta integración optimiza la administración de datos al permitir el envío directo de datos de formulario a la hoja de cálculo elegida, lo que elimina la transferencia manual de datos y reduce los errores.
