...
* [!DNL Experience Manager] amplía la funcionalidad Recursos conectados para admitir el uso de [!DNL Dynamic Media] imágenes en los componentes principales admitidos. Consulte [utilizar recursos conectados](/help/assets/use-assets-across-connected-assets-instances.md).
...
Puede utilizar [AEM Forms as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/home.html) para crear formularios digitales, conecte formularios a fuentes de datos existentes, integre formularios con Adobe Sign para añadir firmas electrónicas a formularios y genere un documento de registro (DoR) para archivar los formularios enviados como archivos de PDF. El servicio también puede convertir los PDF forms existentes en formularios digitales. Además de las funciones estándar de AEM Forms, el servicio ofrece varias funciones nativas de la nube, como escalado automático, tiempo de inactividad cero para las actualizaciones y un entorno de desarrollo nativo en la nube. Leer [esta publicación de blog](https://blog.adobe.com/en/publish/2021/03/11/experience-manager-forms-as-a-cloud-service.html) para obtener más información sobre las funcionalidades y características de AEM Forms as a Cloud Service.
...
* **AEM Actualización de push** ahora, la etiqueta se mostrará para ambos *Ejecución de canalización* y *Actividad* pantallas.
...
* Capacidad para filtrar los resultados de ACS Commons desde el informe BPA en la interfaz de usuario, así como desde el informe exportado como archivo CSV.
...
* Nuevas funciones y mejoras para el Modernizador de repositorios. Consulte [Recurso de GitHub: Modernizador de repositorio](https://github.com/adobe/aem-cloud-service-source-migration/tree/master/packages/repository-modernizer) para la última versión.
