...
description: '[!DNL Adobe Experience Manager] Notas de la versión de as a Cloud Service para 2021.3.0.'
...
* [!DNL Experience Manager] amplía la funcionalidad de Assets conectado para admitir el uso de imágenes de [!DNL Dynamic Media] en los componentes principales admitidos. Vea el [uso de recursos conectados](/help/assets/use-assets-across-connected-assets-instances.md).
...
* En la representación de PDF solo está la última página de la plantilla de InDesign. (CQ-4317305)
...
* Lanzamiento del sitio de referencia de Venia de CIF el 25 de marzo de 2021, que incluye la versión más reciente de componentes principales de CIF, la versión 1.9.0. Consulte [Sitio de referencia de Venia en CIF](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2021.03.25) para obtener más información.
...
* Ahora se mostrará la etiqueta **AEM Push Update** para las pantallas *Ejecución de canalización* y *Actividad*.
