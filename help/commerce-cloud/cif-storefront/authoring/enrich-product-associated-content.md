...
# Enriquecimiento de datos de producto con contenido de AEM asociado {#enrich-product-data}
...
También es posible personalizar una plantilla completa para un conjunto específico de productos o categorías. Aprenda a hacerlo [creando varias categorías y páginas de productos.](/help/commerce-cloud/cif-storefront/authoring/multi-template-usage.md)
