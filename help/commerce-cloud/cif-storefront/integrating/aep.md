...
Los componentes principales de [Commerce integration framework (CIF)](https://github.com/adobe/aem-core-cif-components) se integran perfectamente con [Adobe Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/landing/platform-overview.html) para reenviar eventos de tienda y sus datos a partir de interacciones del lado del cliente, como __agregar al carro de compras__.
...
Cree e implemente el proyecto de AEM Commerce creado en el SDK de AEM local ejecutando el siguiente comando desde el directorio raíz del proyecto.
...
![Sitio AEM Commerce predeterminado](../assets/aep-integration/demo-aem-storefront.png)
...
Para recibir y almacenar los datos de evento procedentes de las páginas de AEM Commerce, como la categoría y el producto, complete los siguientes pasos:
...
1. Cree e implemente el proyecto de AEM Commerce actualizado
